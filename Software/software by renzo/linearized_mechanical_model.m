...
% Stable Point, pendulum downward
theta_0 = 0;
thetadot_0 = 0;
thetadotdot_0 = 0;
alpha_0 = pi;  % Pendulum DOWNWARD
alphadot_0 = 0;
alphadotdot_0 = 0;
Va_0 = 0; 
...
A = double(subs(A,[Lr lp Jr_ex mp Jp g Ke Kc Ra],[Lr_ lp_ Jr_ex_ mp_ Jp_ g_ Ke_ Kc_ Ra_]));
B = double(subs(B,[Lr lp Jr_ex mp Jp g Ke Kc Ra],[Lr_ lp_ Jr_ex_ mp_ Jp_ g_ Ke_ Kc_ Ra_]));
