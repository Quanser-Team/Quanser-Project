###########################################################################
## Makefile generated for component 'Swingup_energy_prova'. 
## 
## Makefile     : Swingup_energy_prova.mk
## Generated on : Thu Nov 16 17:28:01 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Swingup_energy_prova.rt-win64
...
COMPILER_COMMAND_FILE     = Swingup_energy_prova_comp.rsp
CMD_FILE                  = Swingup_energy_prova.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Swingup_energy_prova.rt-win64
...
DEFINES_STANDARD = -DMODEL=Swingup_energy_prova -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova.c $(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova_data.c $(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova_main.c $(START_DIR)\Swingup_energy_prova_quarc_win64\rtGetInf.c $(START_DIR)\Swingup_energy_prova_quarc_win64\rtGetNaN.c $(START_DIR)\Swingup_energy_prova_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Swingup_energy_prova.obj Swingup_energy_prova_data.obj Swingup_energy_prova_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Swingup_energy_prova_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Swingup_energy_prova_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Swingup_energy_prova.obj : "$(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova.c"


Swingup_energy_prova_data.obj : "$(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova_data.c"


Swingup_energy_prova_main.obj : "$(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_prova_quarc_win64\Swingup_energy_prova_main.c"


rtGetInf.obj : "$(START_DIR)\Swingup_energy_prova_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_prova_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Swingup_energy_prova_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_prova_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Swingup_energy_prova_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_prova_quarc_win64\rt_nonfinite.c"
