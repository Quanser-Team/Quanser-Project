...
#ifndef RTW_HEADER_Swingup_energy_prova_h_
#define RTW_HEADER_Swingup_energy_prova_h_
#ifndef Swingup_energy_prova_COMMON_INCLUDES_
#define Swingup_energy_prova_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                               /* Swingup_energy_prova_COMMON_INCLUDES_ */

#include "Swingup_energy_prova_types.h"
#include "rtGetNaN.h"
...
#define Swingup_energy_prova_rtModel   RT_MODEL_Swingup_energy_prova_T
...
#define rtB                            Swingup_energy_prova_B
#define BlockIO                        B_Swingup_energy_prova_T
#define rtX                            Swingup_energy_prova_X
#define ContinuousStates               X_Swingup_energy_prova_T
#define rtXdot                         Swingup_energy_prova_XDot
#define StateDerivatives               XDot_Swingup_energy_prova_T
#define tXdis                          Swingup_energy_prova_XDis
#define StateDisabled                  XDis_Swingup_energy_prova_T
#define rtP                            Swingup_energy_prova_P
#define Parameters                     P_Swingup_energy_prova_T
#define rtDWork                        Swingup_energy_prova_DW
#define D_Work                         DW_Swingup_energy_prova_T

/* Parameters (default storage) */
struct P_Swingup_energy_prova_T_ {
  ...
  real_T Saturation_LowerSat;          /* Expression: -5
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Switch_Threshold;             /* Expression: 0.95
...
struct tag_RTM_Swingup_energy_prova_T {
  const char_T *path;
...
extern P_Swingup_energy_prova_T Swingup_energy_prova_P;

/* Block signals (default storage) */
extern B_Swingup_energy_prova_T Swingup_energy_prova_B;

/* Continuous states (default storage) */
extern X_Swingup_energy_prova_T Swingup_energy_prova_X;

/* Block states (default storage) */
extern DW_Swingup_energy_prova_T Swingup_energy_prova_DW;

/* Model entry point functions */
extern void Swingup_energy_prova_initialize(void);
extern void Swingup_energy_prova_output(void);
extern void Swingup_energy_prova_update(void);
extern void Swingup_energy_prova_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Swingup_energy_prova_rtModel *Swingup_energy_prova(void);
...
extern RT_MODEL_Swingup_energy_prova_T *const Swingup_energy_prova_M;
 ...
 *
 * '<Root>' : 'Swingup_energy_prova'
 * '<S1>'   : 'Swingup_energy_prova/Degrees to Radians'
 * '<S2>'   : 'Swingup_energy_prova/MATLAB Function'
 * '<S3>'   : 'Swingup_energy_prova/MATLAB Function1'
 * '<S4>'   : 'Swingup_energy_prova/MATLAB Function2'
 * '<S5>'   : 'Swingup_energy_prova/MATLAB Function3'
 * '<S6>'   : 'Swingup_energy_prova/Radians to Degrees'
 * '<S7>'   : 'Swingup_energy_prova/Radians to Degrees1'
 * '<S8>'   : 'Swingup_energy_prova/Stall Detection'
 * '<S9>'   : 'Swingup_energy_prova/Stall Detection/Stall Monitor'
 * '<S10>'  : 'Swingup_energy_prova/Stall Detection/Stop with Message'
 * '<S11>'  : 'Swingup_energy_prova/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Swingup_energy_prova_h_ */
