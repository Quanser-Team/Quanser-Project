...
RT_MODEL_Pippo_sim_T *Pippo_sim(void)
{
  ...
  /* External mode info */
  Pippo_sim_M->Sizes.checksums[0] = (1296412684U);
  Pippo_sim_M->Sizes.checksums[1] = (3692602560U);
  Pippo_sim_M->Sizes.checksums[2] = (217851060U);
  Pippo_sim_M->Sizes.checksums[3] = (735665325U);
  ...
  Pippo_sim_M->Sizes.numBlocks = (21); /* Number of blocks */
  Pippo_sim_M->Sizes.numBlockIO = (5); /* Number of block outputs */
  Pippo_sim_M->Sizes.numBlockPrms = (97);/* Sum of parameter "widths" */
  return Pippo_sim_M;
}
