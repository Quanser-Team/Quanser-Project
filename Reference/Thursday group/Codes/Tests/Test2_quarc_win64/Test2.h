...
typedef struct {
  ...
  real_T ServoVelocity1;               /* '<Root>/Servo Velocity1' */
...
typedef struct {
  ...
  struct {
    ...
    real_T Sin_w_t;
    real_T Cos_w_t;
  } SmoothSignalGenerator1_RWORK;      /* '<Root>/Smooth Signal Generator1' */
...
#define rtX                            Test2_X
#define ContinuousStates               X_Test2_T
#define rtXdot                         Test2_XDot
#define StateDerivatives               XDot_Test2_T
#define tXdis                          Test2_XDis
#define StateDisabled                  XDis_Test2_T
#define rtP                            Test2_P
...
struct P_Test2_T_ {
  ...
  real_T DiscreteTimeIntegrator_IC;    /* Expression: 0
                                        * Referenced by: '<S8>/Discrete-Time Integrator'
                                        */
  real_T SmoothSignalGenerator1_InitialP;/* Expression: initial_phase
                                          * Referenced by: '<Root>/Smooth Signal Generator1'
                                          */
  real_T SmoothSignalGenerator1_Amplitud;/* Expression: i_amplitude
                                          * Referenced by: '<Root>/Smooth Signal Generator1'
                                          */
  real_T SmoothSignalGenerator1_Frequenc;/* Expression: i_frequency
                                          * Referenced by: '<Root>/Smooth Signal Generator1'
                                          */
...
extern void Test2_output(void);
extern void Test2_update(void);
 ...
 *
 * '<Root>' : 'Test2'
 * '<S1>'   : 'Test2/Degrees to Radians'
 * '<S2>'   : 'Test2/Degrees to Radians1'
 * '<S3>'   : 'Test2/Derivative Gain'
 * '<S4>'   : 'Test2/Proportional Gain'
 * '<S5>'   : 'Test2/Radians to Degrees'
 * '<S6>'   : 'Test2/Radians to Degrees1'
 * '<S7>'   : 'Test2/Stall Detection'
 * '<S8>'   : 'Test2/Stall Detection/Stall Monitor'
 * '<S9>'   : 'Test2/Stall Detection/Stop with Message'
 * '<S10>'  : 'Test2/Stall Detection/Stop with Message/Compare'
 */
