...
## 
## Makefile     : Test2.mk
## Generated on : Thu Sep 28 18:38:15 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test2.rt-win64
...
START_DIR                 = C:\Users\Utente\ONEDRI~1\THURSD~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Test2_comp.rsp
CMD_FILE                  = Test2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test2.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test2 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test2_quarc_win64\Test2.c $(START_DIR)\Test2_quarc_win64\Test2_data.c $(START_DIR)\Test2_quarc_win64\Test2_main.c $(START_DIR)\Test2_quarc_win64\rtGetInf.c $(START_DIR)\Test2_quarc_win64\rtGetNaN.c $(START_DIR)\Test2_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test2.obj Test2_data.obj Test2_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test2_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test2_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test2.obj : "$(START_DIR)\Test2_quarc_win64\Test2.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test2_quarc_win64\Test2.c"


Test2_data.obj : "$(START_DIR)\Test2_quarc_win64\Test2_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test2_quarc_win64\Test2_data.c"


Test2_main.obj : "$(START_DIR)\Test2_quarc_win64\Test2_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test2_quarc_win64\Test2_main.c"


rtGetInf.obj : "$(START_DIR)\Test2_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test2_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test2_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test2_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test2_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test2_quarc_win64\rt_nonfinite.c"
