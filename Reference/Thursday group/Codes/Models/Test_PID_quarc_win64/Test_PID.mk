###########################################################################
## Makefile generated for component 'Test_PID'. 
## 
## Makefile     : Test_PID.mk
## Generated on : Thu Oct 19 18:21:46 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test_PID.rt-win64
...
COMPILER_COMMAND_FILE     = Test_PID_comp.rsp
CMD_FILE                  = Test_PID.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test_PID.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test_PID -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test_PID_quarc_win64\Test_PID.c $(START_DIR)\Test_PID_quarc_win64\Test_PID_data.c $(START_DIR)\Test_PID_quarc_win64\Test_PID_main.c $(START_DIR)\Test_PID_quarc_win64\rtGetInf.c $(START_DIR)\Test_PID_quarc_win64\rtGetNaN.c $(START_DIR)\Test_PID_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test_PID.obj Test_PID_data.obj Test_PID_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test_PID_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test_PID_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test_PID.obj : "$(START_DIR)\Test_PID_quarc_win64\Test_PID.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_quarc_win64\Test_PID.c"


Test_PID_data.obj : "$(START_DIR)\Test_PID_quarc_win64\Test_PID_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_quarc_win64\Test_PID_data.c"


Test_PID_main.obj : "$(START_DIR)\Test_PID_quarc_win64\Test_PID_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_quarc_win64\Test_PID_main.c"


rtGetInf.obj : "$(START_DIR)\Test_PID_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test_PID_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test_PID_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_quarc_win64\rt_nonfinite.c"
