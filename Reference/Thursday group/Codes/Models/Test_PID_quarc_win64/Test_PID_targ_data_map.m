    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.PIDController_D
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_PID_P.PIDController_I
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_PID_P.PIDController_InitialConditionF
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% Test_PID_P.PIDController_InitialConditio_p
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_PID_P.PIDController_N
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 5;

                    ;% Test_PID_P.PIDController_P
                    ...
                    ;% Test_PID_P.StallMonitor_motion_threshold
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.HILWriteAnalog_channels
                    section.data(1).logicalSrcIdx = 10;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_PID_P.HILReadEncoder_channels
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.StopwithMessage_message_icon
            ...
            section.data(33)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.HILInitialize_OOTerminate
                    section.data(1).logicalSrcIdx = 13;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_PID_P.HILInitialize_OOExit
                    section.data(2).logicalSrcIdx = 14;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_PID_P.HILInitialize_OOStart
                    section.data(3).logicalSrcIdx = 15;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_PID_P.HILInitialize_OOEnter
                    ...
                    ;% Test_PID_P.HILInitialize_AIHigh
                    section.data(7).logicalSrcIdx = 19;
                    section.data(7).dtTransOffset = 8;

                    ;% Test_PID_P.HILInitialize_AILow
                    section.data(8).logicalSrcIdx = 20;
                    section.data(8).dtTransOffset = 9;

                    ;% Test_PID_P.HILInitialize_AOHigh
                    section.data(9).logicalSrcIdx = 21;
                    section.data(9).dtTransOffset = 10;

                    ;% Test_PID_P.HILInitialize_AOLow
                    ...
                    ;% Test_PID_P.HILInitialize_AOWatchdog
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.HILInitialize_CKChannels
                    section.data(1).logicalSrcIdx = 46;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_PID_P.HILInitialize_DOWatchdog
                    ...
                    ;% Test_PID_P.HILReadEncoderTimebase_Clock
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.HILInitialize_AIChannels
                    ...
                    ;% Test_PID_P.HILInitialize_EIChannels
                    ...
                    ;% Test_PID_P.HILReadEncoderTimebase_Channels
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.HILReadEncoderTimebase_Active
                    section.data(37).logicalSrcIdx = 94;
                    section.data(37).dtTransOffset = 36;

                    ;% Test_PID_P.HILWriteAnalog_Active
                    section.data(38).logicalSrcIdx = 95;
                    section.data(38).dtTransOffset = 37;

                    ;% Test_PID_P.HILReadEncoder_Active
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_PID_P.HILReadEncoderTimebase_Overflow
    ...
    ;%**************************
        ...
        ;%
        ;% Auto data (Test_PID_B)
        ;%
            section.nData     = 12;
            section.data(12)  = dumData; %prealloc

                    ;% Test_PID_B.ProportionalGain
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_PID_B.DerivativeGain
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
                    ...
                    ;% Test_PID_B.Saturation
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% Test_PID_B.countstorad1
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;
                    ...
                    ;% Test_PID_B.DataTypeConversion
                    section.data(10).logicalSrcIdx = 9;
                    section.data(10).dtTransOffset = 10;

                    ;% Test_PID_B.IntegralGain
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_PID_B.RelationalOperator2
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_PID_DW.HILInitialize_FilterFrequency
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_PID_DW.HILInitialize_Card
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% Test_PID_DW.HILWriteAnalog_PWORK
                    section.data(1).logicalSrcIdx = 5;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_PID_DW.MotorVoltageV_PWORK.LoggedData
                    section.data(2).logicalSrcIdx = 6;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_PID_DW.HILReadEncoder_PWORK
                    section.data(3).logicalSrcIdx = 7;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_PID_DW.PendAngledeg1_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 8;
                    section.data(4).dtTransOffset = 3;

                    ;% Test_PID_DW.Scope_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 9;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_PID_DW.ServoAngledeg_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 10;
                    section.data(6).dtTransOffset = 5;

                    ;% Test_PID_DW.ToWorkspace_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 11;
                    section.data(7).dtTransOffset = 6;

                    ;% Test_PID_DW.ToWorkspace1_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 12;
                    section.data(8).dtTransOffset = 7;

                    ;% Test_PID_DW.ToWorkspace2_PWORK.LoggedData
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% Test_PID_DW.HILInitialize_ClockModes
                    section.data(1).logicalSrcIdx = 14;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_PID_DW.HILInitialize_DOStates
                    section.data(2).logicalSrcIdx = 15;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_PID_DW.HILInitialize_QuadratureModes
                    section.data(3).logicalSrcIdx = 16;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_PID_DW.HILInitialize_InitialEICounts
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_PID_DW.DiscreteTimeIntegrator_PrevRese
    ...
    targMap.checksum0 = 96660718;
    targMap.checksum1 = 1943079243;
    targMap.checksum2 = 314535757;
    targMap.checksum3 = 2048634942;
