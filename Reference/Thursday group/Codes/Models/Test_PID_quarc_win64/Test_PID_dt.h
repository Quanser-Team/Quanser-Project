...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&Test_PID_B.ProportionalGain), 0, 0, 13 },
  ...
  { (char_T *)(&Test_PID_DW.HILWriteAnalog_PWORK), 11, 0, 9 },
