###########################################################################
## Makefile generated for component 'Test_PP'. 
## 
## Makefile     : Test_PP.mk
## Generated on : Thu Oct 19 16:16:34 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test_PP.rt-win64
...
COMPILER_COMMAND_FILE     = Test_PP_comp.rsp
CMD_FILE                  = Test_PP.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test_PP.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test_PP -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test_PP_quarc_win64\Test_PP.c $(START_DIR)\Test_PP_quarc_win64\Test_PP_data.c $(START_DIR)\Test_PP_quarc_win64\Test_PP_main.c $(START_DIR)\Test_PP_quarc_win64\rtGetInf.c $(START_DIR)\Test_PP_quarc_win64\rtGetNaN.c $(START_DIR)\Test_PP_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test_PP.obj Test_PP_data.obj Test_PP_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test_PP_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test_PP_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test_PP.obj : "$(START_DIR)\Test_PP_quarc_win64\Test_PP.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PP_quarc_win64\Test_PP.c"


Test_PP_data.obj : "$(START_DIR)\Test_PP_quarc_win64\Test_PP_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PP_quarc_win64\Test_PP_data.c"


Test_PP_main.obj : "$(START_DIR)\Test_PP_quarc_win64\Test_PP_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PP_quarc_win64\Test_PP_main.c"


rtGetInf.obj : "$(START_DIR)\Test_PP_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PP_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test_PP_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PP_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test_PP_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PP_quarc_win64\rt_nonfinite.c"
