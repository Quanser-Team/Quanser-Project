...
#ifndef RTW_HEADER_Test_PP_h_
#define RTW_HEADER_Test_PP_h_
#ifndef Test_PP_COMMON_INCLUDES_
#define Test_PP_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Test_PP_COMMON_INCLUDES_ */

#include "Test_PP_types.h"
#include "rtGetInf.h"
...
#define Test_PP_rtModel                RT_MODEL_Test_PP_T
...
#define rtB                            Test_PP_B
#define BlockIO                        B_Test_PP_T
#define rtX                            Test_PP_X
#define ContinuousStates               X_Test_PP_T
#define rtXdot                         Test_PP_XDot
#define StateDerivatives               XDot_Test_PP_T
#define tXdis                          Test_PP_XDis
#define StateDisabled                  XDis_Test_PP_T
#define rtP                            Test_PP_P
#define Parameters                     P_Test_PP_T
#define rtDWork                        Test_PP_DW
#define D_Work                         DW_Test_PP_T
...
extern P_Test_PP_T Test_PP_P;

/* Block signals (default storage) */
extern B_Test_PP_T Test_PP_B;

/* Continuous states (default storage) */
extern X_Test_PP_T Test_PP_X;

/* Block states (default storage) */
extern DW_Test_PP_T Test_PP_DW;

/* Model entry point functions */
extern void Test_PP_initialize(void);
extern void Test_PP_output(void);
extern void Test_PP_update(void);
extern void Test_PP_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Test_PP_rtModel *Test_PP(void);
...
extern RT_MODEL_Test_PP_T *const Test_PP_M;
 ...
 *
 * '<Root>' : 'Test_PP'
 * '<S1>'   : 'Test_PP/Degrees to Radians'
 * '<S2>'   : 'Test_PP/MATLAB Function'
 * '<S3>'   : 'Test_PP/Radians to Degrees'
 * '<S4>'   : 'Test_PP/Radians to Degrees1'
 * '<S5>'   : 'Test_PP/Stall Detection'
 * '<S6>'   : 'Test_PP/Stall Detection/Stall Monitor'
 * '<S7>'   : 'Test_PP/Stall Detection/Stop with Message'
 * '<S8>'   : 'Test_PP/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Test_PP_h_ */
