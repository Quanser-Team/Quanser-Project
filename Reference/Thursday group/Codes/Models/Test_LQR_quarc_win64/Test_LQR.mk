###########################################################################
## Makefile generated for component 'Test_LQR'. 
## 
## Makefile     : Test_LQR.mk
## Generated on : Thu Oct 19 16:02:50 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test_LQR.rt-win64
...
COMPILER_COMMAND_FILE     = Test_LQR_comp.rsp
CMD_FILE                  = Test_LQR.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test_LQR.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test_LQR -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test_LQR_quarc_win64\Test_LQR.c $(START_DIR)\Test_LQR_quarc_win64\Test_LQR_data.c $(START_DIR)\Test_LQR_quarc_win64\Test_LQR_main.c $(START_DIR)\Test_LQR_quarc_win64\rtGetInf.c $(START_DIR)\Test_LQR_quarc_win64\rtGetNaN.c $(START_DIR)\Test_LQR_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test_LQR.obj Test_LQR_data.obj Test_LQR_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test_LQR_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test_LQR_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test_LQR.obj : "$(START_DIR)\Test_LQR_quarc_win64\Test_LQR.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_quarc_win64\Test_LQR.c"


Test_LQR_data.obj : "$(START_DIR)\Test_LQR_quarc_win64\Test_LQR_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_quarc_win64\Test_LQR_data.c"


Test_LQR_main.obj : "$(START_DIR)\Test_LQR_quarc_win64\Test_LQR_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_quarc_win64\Test_LQR_main.c"


rtGetInf.obj : "$(START_DIR)\Test_LQR_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test_LQR_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test_LQR_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_quarc_win64\rt_nonfinite.c"
