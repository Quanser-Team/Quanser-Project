 ...
 * '<S2>'   : 'Test_PolePlacement/MATLAB Function'
 * '<S3>'   : 'Test_PolePlacement/Radians to Degrees'
 * '<S4>'   : 'Test_PolePlacement/Radians to Degrees1'
 * '<S5>'   : 'Test_PolePlacement/Stall Detection'
 * '<S6>'   : 'Test_PolePlacement/Stall Detection/Stall Monitor'
 * '<S7>'   : 'Test_PolePlacement/Stall Detection/Stop with Message'
 * '<S8>'   : 'Test_PolePlacement/Stall Detection/Stop with Message/Compare'
 */
