    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(29)  = dumData; %prealloc
                    ...
                    ;% Test_PolePlacement_P.Gain1_Gain_a
                    ...
                    ;% Test_PolePlacement_P.Gain_Gain_k
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% Test_PolePlacement_DW.TimeStampA
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 3;

                    ;% Test_PolePlacement_DW.LastUAtTimeA
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 4;

                    ;% Test_PolePlacement_DW.TimeStampB
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 5;

                    ;% Test_PolePlacement_DW.LastUAtTimeB
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 6;

                    ;% Test_PolePlacement_DW.TimeStampA_j
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 7;

                    ;% Test_PolePlacement_DW.LastUAtTimeA_m
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 8;
                    ...
                    ;% Test_PolePlacement_DW.LastUAtTimeB_p
    ...
    targMap.checksum0 = 2268380150;
    targMap.checksum1 = 4003810329;
    targMap.checksum2 = 4194916796;
    targMap.checksum3 = 2797900153;
