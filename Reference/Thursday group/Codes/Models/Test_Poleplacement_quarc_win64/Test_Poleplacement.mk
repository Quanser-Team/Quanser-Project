###########################################################################
## Makefile generated for component 'Test_PolePlacement'. 
## 
## Makefile     : Test_PolePlacement.mk
## Generated on : Thu Oct 19 15:52:15 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test_PolePlacement.rt-win64
...
PRODUCT_NAME              = Test_PolePlacement
MAKEFILE                  = Test_PolePlacement.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Utente\Desktop\THRUSD~1\Codes\Models
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Test_PolePlacement_comp.rsp
CMD_FILE                  = Test_PolePlacement.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test_PolePlacement.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test_PolePlacement -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement.c $(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement_data.c $(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement_main.c $(START_DIR)\Test_PolePlacement_quarc_win64\rtGetInf.c $(START_DIR)\Test_PolePlacement_quarc_win64\rtGetNaN.c $(START_DIR)\Test_PolePlacement_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test_PolePlacement.obj Test_PolePlacement_data.obj Test_PolePlacement_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test_PolePlacement_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test_PolePlacement_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test_PolePlacement.obj : "$(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement.c"


Test_PolePlacement_data.obj : "$(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement_data.c"


Test_PolePlacement_main.obj : "$(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PolePlacement_quarc_win64\Test_PolePlacement_main.c"


rtGetInf.obj : "$(START_DIR)\Test_PolePlacement_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PolePlacement_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test_PolePlacement_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PolePlacement_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test_PolePlacement_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PolePlacement_quarc_win64\rt_nonfinite.c"
