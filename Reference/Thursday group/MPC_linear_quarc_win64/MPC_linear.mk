###########################################################################
## Makefile generated for component 'MPC_linear'. 
## 
## Makefile     : MPC_linear.mk
## Generated on : Tue Nov 28 16:47:06 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\MPC_linear.rt-win64
...
COMPILER_COMMAND_FILE     = MPC_linear_comp.rsp
CMD_FILE                  = MPC_linear.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\MPC_linear.rt-win64
...
DEFINES_STANDARD = -DMODEL=MPC_linear -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\MPC_linear_quarc_win64\MPC_linear.c $(START_DIR)\MPC_linear_quarc_win64\MPC_linear_data.c $(START_DIR)\MPC_linear_quarc_win64\MPC_linear_main.c $(START_DIR)\MPC_linear_quarc_win64\rtGetInf.c $(START_DIR)\MPC_linear_quarc_win64\rtGetNaN.c $(START_DIR)\MPC_linear_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = MPC_linear.obj MPC_linear_data.obj MPC_linear_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\MPC_linear_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\MPC_linear_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
MPC_linear.obj : "$(START_DIR)\MPC_linear_quarc_win64\MPC_linear.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\MPC_linear_quarc_win64\MPC_linear.c"


MPC_linear_data.obj : "$(START_DIR)\MPC_linear_quarc_win64\MPC_linear_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\MPC_linear_quarc_win64\MPC_linear_data.c"


MPC_linear_main.obj : "$(START_DIR)\MPC_linear_quarc_win64\MPC_linear_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\MPC_linear_quarc_win64\MPC_linear_main.c"


rtGetInf.obj : "$(START_DIR)\MPC_linear_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\MPC_linear_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\MPC_linear_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\MPC_linear_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\MPC_linear_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\MPC_linear_quarc_win64\rt_nonfinite.c"
