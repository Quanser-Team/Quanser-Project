...
#ifndef RTW_HEADER_MPC_linear_h_
#define RTW_HEADER_MPC_linear_h_
#ifndef MPC_linear_COMMON_INCLUDES_
#define MPC_linear_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* MPC_linear_COMMON_INCLUDES_ */
...
#define MPC_linear_rtModel             RT_MODEL_MPC_linear_T
...
typedef struct {
  ...
  real_T xk1[7];                       /* '<S26>/optimizer' */
  real_T u;                            /* '<S26>/optimizer' */
  boolean_T LogicalOperator1;          /* '<S28>/Logical Operator1' */
  boolean_T RelationalOperator2;       /* '<S28>/Relational Operator2' */
  boolean_T iAout[24];                 /* '<S26>/optimizer' */
} B_MPC_linear_T;
...
typedef struct {
  ...
  real_T TmpRTBAtoptimizerInport3_Buffer[4];/* synthesized block */
  real_T last_x_PreviousInput[7];      /* '<S6>/last_x' */
  ...
  boolean_T Memory_PreviousInput[24];  /* '<S6>/Memory' */
} DW_MPC_linear_T;
...
#define rtB                            MPC_linear_B
#define BlockIO                        B_MPC_linear_T
#define rtX                            MPC_linear_X
#define ContinuousStates               X_MPC_linear_T
#define rtXdot                         MPC_linear_XDot
#define StateDerivatives               XDot_MPC_linear_T
#define tXdis                          MPC_linear_XDis
#define StateDisabled                  XDis_MPC_linear_T
#define rtP                            MPC_linear_P
#define Parameters                     P_MPC_linear_T
#define rtDWork                        MPC_linear_DW
#define D_Work                         DW_MPC_linear_T

/* Parameters (default storage) */
struct P_MPC_linear_T_ {
  real_T StallMonitor_control_threshold;
                               /* Mask Parameter: StallMonitor_control_threshold
                                * Referenced by: '<S28>/control threshold'
                                */
  real_T StallMonitor_duration_s;     /* Mask Parameter: StallMonitor_duration_s
                                       * Referenced by: '<S28>/control threshold1'
                                       */
  real_T StallMonitor_motion_threshold;
                                /* Mask Parameter: StallMonitor_motion_threshold
                                 * Referenced by: '<S28>/motion threshold'
                                 */
  ...
  boolean_T HILReadEncoder_Active;  /* Computed Parameter: HILReadEncoder_Active
                                     * Referenced by: '<Root>/HIL Read Encoder'
                                     */
  boolean_T Memory_InitialCondition[24];/* Expression: iA
...
extern P_MPC_linear_T MPC_linear_P;

/* Block signals (default storage) */
extern B_MPC_linear_T MPC_linear_B;

/* Continuous states (default storage) */
extern X_MPC_linear_T MPC_linear_X;

/* Block states (default storage) */
extern DW_MPC_linear_T MPC_linear_DW;
...
extern void MPC_linear_initialize(void);
extern void MPC_linear_output0(void);
extern void MPC_linear_update0(void);
extern void MPC_linear_output2(void);
extern void MPC_linear_update2(void);
extern void MPC_linear_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern MPC_linear_rtModel *MPC_linear(void);
...
extern RT_MODEL_MPC_linear_T *const MPC_linear_M;
 ...
 *
 * '<Root>' : 'MPC_linear'
 * '<S1>'   : 'MPC_linear/Degrees to Radians'
 * '<S2>'   : 'MPC_linear/MPC Controller'
 * '<S3>'   : 'MPC_linear/Radians to Degrees'
 * '<S4>'   : 'MPC_linear/Radians to Degrees1'
 * '<S5>'   : 'MPC_linear/Stall Detection'
 * '<S6>'   : 'MPC_linear/MPC Controller/MPC'
 * '<S7>'   : 'MPC_linear/MPC Controller/MPC/MPC Matrix Signal Check'
 * '<S8>'   : 'MPC_linear/MPC Controller/MPC/MPC Matrix Signal Check1'
 * '<S9>'   : 'MPC_linear/MPC Controller/MPC/MPC Matrix Signal Check2'
 * '<S10>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check'
 * '<S11>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check1'
 * '<S12>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check2'
 * '<S13>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check3'
 * '<S14>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check4'
 * '<S15>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check5'
 * '<S16>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check6'
 * '<S17>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check7'
 * '<S18>'  : 'MPC_linear/MPC Controller/MPC/MPC Preview Signal Check8'
 * '<S19>'  : 'MPC_linear/MPC Controller/MPC/MPC Scalar Signal Check'
 * '<S20>'  : 'MPC_linear/MPC Controller/MPC/MPC Scalar Signal Check1'
 * '<S21>'  : 'MPC_linear/MPC Controller/MPC/MPC Scalar Signal Check2'
 * '<S22>'  : 'MPC_linear/MPC Controller/MPC/MPC Vector Signal Check'
 * '<S23>'  : 'MPC_linear/MPC Controller/MPC/MPC Vector Signal Check1'
 * '<S24>'  : 'MPC_linear/MPC Controller/MPC/MPC Vector Signal Check6'
 * '<S25>'  : 'MPC_linear/MPC Controller/MPC/moorx'
 * '<S26>'  : 'MPC_linear/MPC Controller/MPC/optimizer'
 * '<S27>'  : 'MPC_linear/MPC Controller/MPC/optimizer/optimizer'
 * '<S28>'  : 'MPC_linear/Stall Detection/Stall Monitor'
 * '<S29>'  : 'MPC_linear/Stall Detection/Stop with Message'
 * '<S30>'  : 'MPC_linear/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_MPC_linear_h_ */
