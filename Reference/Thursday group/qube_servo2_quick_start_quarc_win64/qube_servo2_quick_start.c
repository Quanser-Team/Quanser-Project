...
void qube_servo2_quick_start_initialize(void)
{
  ...
  /* S-Function Block: qube_servo2_quick_start/HIL Initialize (hil_initialize_block) */
  {
    ...
    result = hil_set_card_specific_options
      (qube_servo2_quick_start_DW.HILInitialize_Card, " ", 2);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(qube_servo2_quick_start_M, _rt_error_message);
...
RT_MODEL_qube_servo2_quick_st_T *qube_servo2_quick_start(void)
{
  ...
  /* External mode info */
  qube_servo2_quick_start_M->Sizes.checksums[0] = (3688193665U);
  qube_servo2_quick_start_M->Sizes.checksums[1] = (854651587U);
  qube_servo2_quick_start_M->Sizes.checksums[2] = (356613279U);
  qube_servo2_quick_start_M->Sizes.checksums[3] = (143462815U);
