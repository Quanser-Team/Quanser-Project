 ...
 * '<S2>'   : 'Test/MATLAB Function1'
 * '<S3>'   : 'Test/Radians to Degrees'
 * '<S4>'   : 'Test/Radians to Degrees1'
 * '<S5>'   : 'Test/Radians to Degrees2'
 * '<S6>'   : 'Test/Radians to Degrees3'
 * '<S7>'   : 'Test/Stall Detection'
 * '<S8>'   : 'Test/Stall Detection/Stall Monitor'
 * '<S9>'   : 'Test/Stall Detection/Stop with Message'
 * '<S10>'  : 'Test/Stall Detection/Stop with Message/Compare'
 */
