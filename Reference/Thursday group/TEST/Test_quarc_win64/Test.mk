...
## 
## Makefile     : Test.mk
## Generated on : Thu Oct 26 16:29:53 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test.rt-win64
...
START_DIR                 = C:\Users\Utente\Desktop\THRUSD~1\TEST
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test_quarc_win64\Test.c $(START_DIR)\Test_quarc_win64\Test_data.c $(START_DIR)\Test_quarc_win64\Test_main.c $(START_DIR)\Test_quarc_win64\rtGetInf.c $(START_DIR)\Test_quarc_win64\rtGetNaN.c $(START_DIR)\Test_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test.obj Test_data.obj Test_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test.obj : "$(START_DIR)\Test_quarc_win64\Test.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_quarc_win64\Test.c"


Test_data.obj : "$(START_DIR)\Test_quarc_win64\Test_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_quarc_win64\Test_data.c"


Test_main.obj : "$(START_DIR)\Test_quarc_win64\Test_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_quarc_win64\Test_main.c"


rtGetInf.obj : "$(START_DIR)\Test_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_quarc_win64\rt_nonfinite.c"
