    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(32)  = dumData; %prealloc
                    ...
                    ;% Test_P.StateSpace_InitialCondition
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% Test_DW.ToWorkspace1_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 9;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_DW.ToWorkspace2_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 10;
                    section.data(6).dtTransOffset = 5;

                    ;% Test_DW.ToWorkspace3_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 11;
                    section.data(7).dtTransOffset = 6;

                    ;% Test_DW.ToWorkspace4_PWORK.LoggedData
    ...
    targMap.checksum0 = 3672164930;
    targMap.checksum1 = 1580385623;
    targMap.checksum2 = 737826116;
    targMap.checksum3 = 3308674283;
