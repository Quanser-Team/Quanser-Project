...
/* Continuous states */
X_Test_Poleplacement_T Test_Poleplacement_X;
...
static void rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  ...
  rtsiSetdX(si, f0);
  Test_Poleplacement_derivatives();
  rtsiSetT(si, tnew);
  for (i = 0; i < nXc; ++i) {
    x[i] += h * f0[i];
  }
...
void Test_Poleplacement_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Test_Poleplacement_M)) {
    /* set solver stop time */
    if (!(Test_Poleplacement_M->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&Test_Poleplacement_M->solverInfo,
                            ((Test_Poleplacement_M->Timing.clockTickH0 + 1) *
        Test_Poleplacement_M->Timing.stepSize0 * 4294967296.0));
    } else {
      rtsiSetSolverStopTime(&Test_Poleplacement_M->solverInfo,
                            ((Test_Poleplacement_M->Timing.clockTick0 + 1) *
  ...
  if (rtmIsMinorTimeStep(Test_Poleplacement_M)) {
    Test_Poleplacement_M->Timing.t[0] = rtsiGetT
      (&Test_Poleplacement_M->solverInfo);
  }
  ...
  if (rtmIsMajorTimeStep(Test_Poleplacement_M)) {
    ...
    /* S-Function Block: Test_Poleplacement/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_countstorad = Test_Poleplacement_DW.HILReadEncoderTimebase_Buffer;
      }
    }
     ...
     */
    rtb_Gain1 = Test_Poleplacement_P.Amplitudedeg_Gain * 0.0 *
      Test_Poleplacement_P.Gain1_Gain;

    /* Gain: '<Root>/counts to rad' */
    rtb_countstorad *= Test_Poleplacement_P.countstorad_Gain;

    /* Sum: '<Root>/Sum' */
    rtb_Sum = rtb_Gain1 - rtb_countstorad;

    /* Gain: '<S42>/Proportional Gain' */
    Test_Poleplacement_B.ProportionalGain = Test_Poleplacement_P.PIDController_P
      * rtb_Sum;

    /* Gain: '<S31>/Derivative Gain' */
    Test_Poleplacement_B.DerivativeGain = Test_Poleplacement_P.PIDController_D *
      rtb_Sum;
  }
   ...
   *  Sum: '<S32>/SumD'
   */
  Test_Poleplacement_B.FilterCoefficient = (Test_Poleplacement_B.DerivativeGain
    - Test_Poleplacement_X.Filter_CSTATE) * Test_Poleplacement_P.PIDController_N;

  /* Sum: '<S46>/Sum' incorporates:
   *  Integrator: '<S37>/Integrator'
   */
  u0 = (Test_Poleplacement_B.ProportionalGain +
        Test_Poleplacement_X.Integrator_CSTATE) +
    Test_Poleplacement_B.FilterCoefficient;

  /* Saturate: '<Root>/Saturation' */
  if (u0 > Test_Poleplacement_P.Saturation_UpperSat) {
    /* Saturate: '<Root>/Saturation' */
    Test_Poleplacement_B.Saturation = Test_Poleplacement_P.Saturation_UpperSat;
  } else if (u0 < Test_Poleplacement_P.Saturation_LowerSat) {
    /* Saturate: '<Root>/Saturation' */
    Test_Poleplacement_B.Saturation = Test_Poleplacement_P.Saturation_LowerSat;
  } else {
    /* Saturate: '<Root>/Saturation' */
    Test_Poleplacement_B.Saturation = u0;
  }
  ...
  if (rtmIsMajorTimeStep(Test_Poleplacement_M)) {
    ...
    /* Gain: '<S4>/Gain' */
    Test_Poleplacement_B.Gain = Test_Poleplacement_P.Gain_Gain *
   ...
   */
  Test_Poleplacement_B.NegativeFeedback1 =
    (Test_Poleplacement_P.ServoVelocity1_C *
     Test_Poleplacement_X.ServoVelocity1_CSTATE +
     Test_Poleplacement_P.ServoVelocity1_D * Test_Poleplacement_B.countstorad1) *
    Test_Poleplacement_P.NegativeFeedback1_Gain;
  if (rtmIsMajorTimeStep(Test_Poleplacement_M)) {
    /* Abs: '<S54>/Abs1' */
    rtb_DiscreteTimeIntegrator = fabs(Test_Poleplacement_B.NegativeFeedback1);
    ...
    Test_Poleplacement_B.IntegralGain = Test_Poleplacement_P.PIDController_I *
      rtb_Sum;
...
void Test_Poleplacement_update(void)
{
  ...
  if (rtmIsMajorTimeStep(Test_Poleplacement_M)) {
    rt_ertODEUpdateContinuousStates(&Test_Poleplacement_M->solverInfo);
  }
  ...
  Test_Poleplacement_M->Timing.t[0] = rtsiGetSolverStopTime
    (&Test_Poleplacement_M->solverInfo);
...
void Test_Poleplacement_derivatives(void)
{
  XDot_Test_Poleplacement_T *_rtXdot;
  _rtXdot = ((XDot_Test_Poleplacement_T *) Test_Poleplacement_M->derivs);

  /* Derivatives for Integrator: '<S37>/Integrator' */
  _rtXdot->Integrator_CSTATE = Test_Poleplacement_B.IntegralGain;

  /* Derivatives for Integrator: '<S32>/Filter' */
  _rtXdot->Filter_CSTATE = Test_Poleplacement_B.FilterCoefficient;

  /* Derivatives for TransferFcn: '<Root>/Servo Velocity1' */
  _rtXdot->ServoVelocity1_CSTATE = Test_Poleplacement_P.ServoVelocity1_A *
    Test_Poleplacement_X.ServoVelocity1_CSTATE;
  _rtXdot->ServoVelocity1_CSTATE += Test_Poleplacement_B.countstorad1;
}
...
void Test_Poleplacement_initialize(void)
{
  ...
  Test_Poleplacement_X.Integrator_CSTATE =
    Test_Poleplacement_P.PIDController_InitialConditio_p;

  /* InitializeConditions for Integrator: '<S32>/Filter' */
  Test_Poleplacement_X.Filter_CSTATE =
    Test_Poleplacement_P.PIDController_InitialConditionF;

  /* InitializeConditions for TransferFcn: '<Root>/Servo Velocity1' */
  Test_Poleplacement_X.ServoVelocity1_CSTATE = 0.0;
...
RT_MODEL_Test_Poleplacement_T *Test_Poleplacement(void)
{
...

  {
    ...
    rtsiSetStepSizePtr(&Test_Poleplacement_M->solverInfo,
                       &Test_Poleplacement_M->Timing.stepSize0);
    rtsiSetdXPtr(&Test_Poleplacement_M->solverInfo,
                 &Test_Poleplacement_M->derivs);
    rtsiSetContStatesPtr(&Test_Poleplacement_M->solverInfo, (real_T **)
                         &Test_Poleplacement_M->contStates);
    rtsiSetNumContStatesPtr(&Test_Poleplacement_M->solverInfo,
      &Test_Poleplacement_M->Sizes.numContStates);
    rtsiSetNumPeriodicContStatesPtr(&Test_Poleplacement_M->solverInfo,
      &Test_Poleplacement_M->Sizes.numPeriodicContStates);
    rtsiSetPeriodicContStateIndicesPtr(&Test_Poleplacement_M->solverInfo,
      &Test_Poleplacement_M->periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr(&Test_Poleplacement_M->solverInfo,
      &Test_Poleplacement_M->periodicContStateRanges);
  ...
  Test_Poleplacement_M->intgData.f[0] = Test_Poleplacement_M->odeF[0];
  Test_Poleplacement_M->contStates = ((real_T *) &Test_Poleplacement_X);
  rtsiSetSolverData(&Test_Poleplacement_M->solverInfo, (void *)
                    &Test_Poleplacement_M->intgData);
  rtsiSetIsMinorTimeStepWithModeChange(&Test_Poleplacement_M->solverInfo, false);
  rtsiSetSolverName(&Test_Poleplacement_M->solverInfo,"ode1");
  ...
  /* External mode info */
  Test_Poleplacement_M->Sizes.checksums[0] = (1494499063U);
  Test_Poleplacement_M->Sizes.checksums[1] = (4145113789U);
  Test_Poleplacement_M->Sizes.checksums[2] = (1746396549U);
  Test_Poleplacement_M->Sizes.checksums[3] = (2933348684U);
  ...
  {
    Test_Poleplacement_B.ProportionalGain = 0.0;
    Test_Poleplacement_B.DerivativeGain = 0.0;
    Test_Poleplacement_B.FilterCoefficient = 0.0;
    ...
    Test_Poleplacement_B.NegativeFeedback1 = 0.0;
    Test_Poleplacement_B.DataTypeConversion = 0.0;
    Test_Poleplacement_B.IntegralGain = 0.0;
  }
  ...
  /* states (continuous) */
  {
    real_T *x = (real_T *) &Test_Poleplacement_X;
    Test_Poleplacement_M->contStates = (x);
    (void) memset((void *)&Test_Poleplacement_X, 0,
                  sizeof(X_Test_Poleplacement_T));
  }
  ...
  /* Initialize Sizes */
  Test_Poleplacement_M->Sizes.numContStates = (3);/* Number of continuous states */
  Test_Poleplacement_M->Sizes.numPeriodicContStates = (0);
  ...
  Test_Poleplacement_M->Sizes.numBlocks = (43);/* Number of blocks */
  Test_Poleplacement_M->Sizes.numBlockIO = (12);/* Number of block outputs */
  Test_Poleplacement_M->Sizes.numBlockPrms = (104);/* Sum of parameter "widths" */
