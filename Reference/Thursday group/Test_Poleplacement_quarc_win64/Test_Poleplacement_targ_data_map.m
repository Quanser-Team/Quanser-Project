    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (Test_Poleplacement_P)
        ;%
            section.nData     = 9;
            section.data(9)  = dumData; %prealloc

                    ;% Test_Poleplacement_P.PIDController_D
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_Poleplacement_P.PIDController_I
                    ...
                    ;% Test_Poleplacement_P.PIDController_N
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_Poleplacement_P.PIDController_P
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_P.HILWriteAnalog_channels
                    section.data(1).logicalSrcIdx = 9;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_Poleplacement_P.HILReadEncoder_channels
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_P.StopwithMessage_message_icon
            ...
            section.data(31)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_P.HILInitialize_OOTerminate
                    section.data(1).logicalSrcIdx = 12;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_Poleplacement_P.HILInitialize_OOExit
                    section.data(2).logicalSrcIdx = 13;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_Poleplacement_P.HILInitialize_OOStart
                    section.data(3).logicalSrcIdx = 14;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_Poleplacement_P.HILInitialize_OOEnter
                    ...
                    ;% Test_Poleplacement_P.Amplitudedeg_Gain
                    ...
                    ;% Test_Poleplacement_P.countstorad_Gain
                    section.data(17).logicalSrcIdx = 28;
                    section.data(17).dtTransOffset = 22;

                    ;% Test_Poleplacement_P.Saturation_UpperSat
                    ...
                    ;% Test_Poleplacement_P.countstorad1_Gain
                    section.data(20).logicalSrcIdx = 31;
                    section.data(20).dtTransOffset = 25;

                    ;% Test_Poleplacement_P.Gain_Gain
                    section.data(21).logicalSrcIdx = 32;
                    section.data(21).dtTransOffset = 26;

                    ;% Test_Poleplacement_P.Gain_Gain_a
                    section.data(22).logicalSrcIdx = 33;
                    section.data(22).dtTransOffset = 27;

                    ;% Test_Poleplacement_P.ServoVelocity1_A
                    ...
                    ;% Test_Poleplacement_P.ServoVelocity1_D
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_P.HILInitialize_CKChannels
                    section.data(1).logicalSrcIdx = 43;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_Poleplacement_P.HILInitialize_DOWatchdog
                    ...
                    ;% Test_Poleplacement_P.HILReadEncoderTimebase_Clock
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_P.HILInitialize_AIChannels
                    ...
                    ;% Test_Poleplacement_P.HILInitialize_EIChannels
                    ...
                    ;% Test_Poleplacement_P.HILReadEncoderTimebase_Channels
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_P.HILInitialize_Active
                    section.data(2).logicalSrcIdx = 56;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_Poleplacement_P.HILInitialize_AOTerminate
                    section.data(3).logicalSrcIdx = 57;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_Poleplacement_P.HILInitialize_AOExit
                    section.data(4).logicalSrcIdx = 58;
                    section.data(4).dtTransOffset = 3;

                    ;% Test_Poleplacement_P.HILInitialize_DOTerminate
                    section.data(5).logicalSrcIdx = 59;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_Poleplacement_P.HILInitialize_DOExit
                    section.data(6).logicalSrcIdx = 60;
                    section.data(6).dtTransOffset = 5;

                    ;% Test_Poleplacement_P.HILInitialize_POTerminate
                    section.data(7).logicalSrcIdx = 61;
                    section.data(7).dtTransOffset = 6;

                    ;% Test_Poleplacement_P.HILInitialize_POExit
                    section.data(8).logicalSrcIdx = 62;
                    section.data(8).dtTransOffset = 7;

                    ;% Test_Poleplacement_P.HILInitialize_CKPStart
                    section.data(9).logicalSrcIdx = 63;
                    section.data(9).dtTransOffset = 8;

                    ;% Test_Poleplacement_P.HILInitialize_CKPEnter
                    section.data(10).logicalSrcIdx = 64;
                    section.data(10).dtTransOffset = 9;

                    ;% Test_Poleplacement_P.HILInitialize_CKStart
                    section.data(11).logicalSrcIdx = 65;
                    section.data(11).dtTransOffset = 10;

                    ;% Test_Poleplacement_P.HILInitialize_CKEnter
                    section.data(12).logicalSrcIdx = 66;
                    section.data(12).dtTransOffset = 11;

                    ;% Test_Poleplacement_P.HILInitialize_AIPStart
                    section.data(13).logicalSrcIdx = 67;
                    section.data(13).dtTransOffset = 12;

                    ;% Test_Poleplacement_P.HILInitialize_AIPEnter
                    section.data(14).logicalSrcIdx = 68;
                    section.data(14).dtTransOffset = 13;

                    ;% Test_Poleplacement_P.HILInitialize_AOPStart
                    section.data(15).logicalSrcIdx = 69;
                    section.data(15).dtTransOffset = 14;

                    ;% Test_Poleplacement_P.HILInitialize_AOPEnter
                    section.data(16).logicalSrcIdx = 70;
                    section.data(16).dtTransOffset = 15;

                    ;% Test_Poleplacement_P.HILInitialize_AOStart
                    section.data(17).logicalSrcIdx = 71;
                    section.data(17).dtTransOffset = 16;

                    ;% Test_Poleplacement_P.HILInitialize_AOEnter
                    section.data(18).logicalSrcIdx = 72;
                    section.data(18).dtTransOffset = 17;

                    ;% Test_Poleplacement_P.HILInitialize_AOReset
                    section.data(19).logicalSrcIdx = 73;
                    section.data(19).dtTransOffset = 18;

                    ;% Test_Poleplacement_P.HILInitialize_DOPStart
                    section.data(20).logicalSrcIdx = 74;
                    section.data(20).dtTransOffset = 19;

                    ;% Test_Poleplacement_P.HILInitialize_DOPEnter
                    section.data(21).logicalSrcIdx = 75;
                    section.data(21).dtTransOffset = 20;

                    ;% Test_Poleplacement_P.HILInitialize_DOStart
                    section.data(22).logicalSrcIdx = 76;
                    section.data(22).dtTransOffset = 21;

                    ;% Test_Poleplacement_P.HILInitialize_DOEnter
                    section.data(23).logicalSrcIdx = 77;
                    section.data(23).dtTransOffset = 22;

                    ;% Test_Poleplacement_P.HILInitialize_DOReset
                    section.data(24).logicalSrcIdx = 78;
                    section.data(24).dtTransOffset = 23;

                    ;% Test_Poleplacement_P.HILInitialize_EIPStart
                    section.data(25).logicalSrcIdx = 79;
                    section.data(25).dtTransOffset = 24;

                    ;% Test_Poleplacement_P.HILInitialize_EIPEnter
                    section.data(26).logicalSrcIdx = 80;
                    section.data(26).dtTransOffset = 25;

                    ;% Test_Poleplacement_P.HILInitialize_EIStart
                    section.data(27).logicalSrcIdx = 81;
                    section.data(27).dtTransOffset = 26;

                    ;% Test_Poleplacement_P.HILInitialize_EIEnter
                    section.data(28).logicalSrcIdx = 82;
                    section.data(28).dtTransOffset = 27;

                    ;% Test_Poleplacement_P.HILInitialize_POPStart
                    section.data(29).logicalSrcIdx = 83;
                    section.data(29).dtTransOffset = 28;

                    ;% Test_Poleplacement_P.HILInitialize_POPEnter
                    section.data(30).logicalSrcIdx = 84;
                    section.data(30).dtTransOffset = 29;

                    ;% Test_Poleplacement_P.HILInitialize_POStart
                    section.data(31).logicalSrcIdx = 85;
                    section.data(31).dtTransOffset = 30;

                    ;% Test_Poleplacement_P.HILInitialize_POEnter
                    section.data(32).logicalSrcIdx = 86;
                    section.data(32).dtTransOffset = 31;

                    ;% Test_Poleplacement_P.HILInitialize_POReset
                    section.data(33).logicalSrcIdx = 87;
                    section.data(33).dtTransOffset = 32;

                    ;% Test_Poleplacement_P.HILInitialize_OOReset
                    ...
                    ;% Test_Poleplacement_P.HILReadEncoderTimebase_Active
                    section.data(37).logicalSrcIdx = 91;
                    section.data(37).dtTransOffset = 36;

                    ;% Test_Poleplacement_P.HILWriteAnalog_Active
                    section.data(38).logicalSrcIdx = 92;
                    section.data(38).dtTransOffset = 37;

                    ;% Test_Poleplacement_P.HILReadEncoder_Active
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_P.HILReadEncoderTimebase_Overflow
    ...
    ;%**************************
        ...
        ;%
        ;% Auto data (Test_Poleplacement_B)
        ;%
            section.nData     = 10;
            section.data(10)  = dumData; %prealloc

                    ;% Test_Poleplacement_B.ProportionalGain
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_Poleplacement_B.DerivativeGain
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
                    ...
                    ;% Test_Poleplacement_B.Gain
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 5;

                    ;% Test_Poleplacement_B.Gain_f
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 6;
                    ...
                    ;% Test_Poleplacement_B.IntegralGain
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_B.RelationalOperator2
    ...
    ;%*******************
        ...
        ;%
        ;% Auto data (Test_Poleplacement_DW)
        ;%
            section.nData     = 2;
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_DW.HILInitialize_FilterFrequency
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_DW.HILWriteAnalog_PWORK
                    section.data(1).logicalSrcIdx = 5;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_Poleplacement_DW.MotorVoltageV_PWORK.LoggedData
                    section.data(2).logicalSrcIdx = 6;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_Poleplacement_DW.HILReadEncoder_PWORK
                    section.data(3).logicalSrcIdx = 7;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_Poleplacement_DW.PendAngledeg1_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 8;
                    section.data(4).dtTransOffset = 3;

                    ;% Test_Poleplacement_DW.ServoAngledeg_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 9;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_Poleplacement_DW.ToWorkspace_PWORK.LoggedData
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_DW.HILInitialize_ClockModes
                    section.data(1).logicalSrcIdx = 11;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_Poleplacement_DW.HILInitialize_DOStates
                    section.data(2).logicalSrcIdx = 12;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_Poleplacement_DW.HILInitialize_QuadratureModes
                    section.data(3).logicalSrcIdx = 13;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_Poleplacement_DW.HILInitialize_InitialEICounts
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_Poleplacement_DW.DiscreteTimeIntegrator_PrevRese
    ...
    targMap.checksum0 = 1494499063;
    targMap.checksum1 = 4145113789;
    targMap.checksum2 = 1746396549;
    targMap.checksum3 = 2933348684;
