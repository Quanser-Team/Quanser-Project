...
typedef struct {
  real_T Jx[12800];
  s_c7IibgiRaKfA3VsAytf19_Swing_T TrialState;
  real_T A_data[8080];
  real_T unusedExpr[6724];
  real_T JacCeqTrans[6560];
  real_T JacEqTrans_tmp[6560];
  real_T Jx_m[6400];
  s_wNHVC0Ht50UohieFHTczdE_Swin_T WorkingSet;
  s_wNHVC0Ht50UohieFHTczdE_Swin_T b_WorkingSet;
  s_wNHVC0Ht50UohieFHTczdE_Swin_T c_WorkingSet;
  real_T tmp_data[3200];
  real_T Au[1600];
  real_T Auf_data[1600];
  real_T Jmv[1600];
  coder_internal_stickyStruct_9_T FcnEvaluator;
  s_nbxu8969ZaTcdhvQHeF5DH_Swin_T QRManager;
  s_3NgQh2XxNZ9U1xDE2ltNMG_Swin_T QPObjective;
  s_MKU8VImszW7wooGA4sgbqF_Swin_T memspace;
  real_T y_data[885];
  real_T y_data_c[885];
  real_T work_data[885];
  real_T work_data_k[885];
  real_T vn1_data[885];
  real_T vn2_data[885];
  real_T work_data_c[885];
  real_T y_data_b[885];
  real_T y_data_p[885];
  real_T y_data_cv[885];
  real_T y_data_f[885];
  real_T y_data_g[885];
  real_T y_data_g1[885];
  s_HcZpBg4ijmZp2DBuNmIQbD_Swin_T CostFcn_workspace_runtimedata;
  s_HcZpBg4ijmZp2DBuNmIQbD_Swin_T ConFcn_workspace_runtimedata;
  ...
  real_T Product1[84];                 /* '<S7>/Product1' */
  real_T Gain2;                        /* '<Root>/Gain2' */
  real_T mv;                           /* '<S6>/NLMPC' */
  real_T mvseq[21];                    /* '<S6>/NLMPC' */
  real_T xseq[84];                     /* '<S6>/NLMPC' */
  real_T e;                            /* '<S6>/NLMPC' */
...
typedef struct {
  ...
  real_T mv_Delay_DSTATE[21];          /* '<S7>/mv_Delay' */
  real_T x_Delay_DSTATE[84];           /* '<S7>/x_Delay' */
  ...
  volatile real_T TmpRTBAtProductInport1_Buffer0[21];/* synthesized block */
  real_T TmpRTBAtx_DelayInport2_Buffer[84];/* synthesized block */
...
struct P_Swingup_MPC_T_ {
  ...
  real_T TransferFcn_D;                /* Computed Parameter: TransferFcn_D
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  real_T ones_Value[21];              /* Expression: ones(PredictionHorizon+1,1)
  ...
  real_T params_zero_Value;            /* Expression: zeros(1,1)
                                        ...
                                        */
  real_T Constant1_Value[19];          /* Expression: 2:max(2,PredictionHorizon)
                                        * Referenced by: '<S7>/Constant1'
                                        */
  real_T Constant_Value_k[19];
