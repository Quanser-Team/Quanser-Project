###########################################################################
## Makefile generated for component 'Swingup_MPC'. 
## 
## Makefile     : Swingup_MPC.mk
## Generated on : Thu Nov 23 15:33:49 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Swingup_MPC.rt-win64
...
COMPILER_COMMAND_FILE     = Swingup_MPC_comp.rsp
CMD_FILE                  = Swingup_MPC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Swingup_MPC.rt-win64
...
DEFINES_STANDARD = -DMODEL=Swingup_MPC -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC.c $(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC_data.c $(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC_main.c $(START_DIR)\Swingup_MPC_quarc_win64\rtGetInf.c $(START_DIR)\Swingup_MPC_quarc_win64\rtGetNaN.c $(START_DIR)\Swingup_MPC_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Swingup_MPC.obj Swingup_MPC_data.obj Swingup_MPC_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Swingup_MPC_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Swingup_MPC_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Swingup_MPC.obj : "$(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC.c"


Swingup_MPC_data.obj : "$(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC_data.c"


Swingup_MPC_main.obj : "$(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_MPC_quarc_win64\Swingup_MPC_main.c"


rtGetInf.obj : "$(START_DIR)\Swingup_MPC_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_MPC_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Swingup_MPC_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_MPC_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Swingup_MPC_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_MPC_quarc_win64\rt_nonfinite.c"
