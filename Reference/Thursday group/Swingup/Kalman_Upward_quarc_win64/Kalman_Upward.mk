###########################################################################
## Makefile generated for component 'Kalman_Upward'. 
## 
## Makefile     : Kalman_Upward.mk
## Generated on : Tue Dec 05 16:22:08 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Kalman_Upward.rt-win64
...
COMPILER_COMMAND_FILE     = Kalman_Upward_comp.rsp
CMD_FILE                  = Kalman_Upward.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Kalman_Upward.rt-win64
...
DEFINES_STANDARD = -DMODEL=Kalman_Upward -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward.c $(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward_data.c $(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward_main.c $(START_DIR)\Kalman_Upward_quarc_win64\rtGetInf.c $(START_DIR)\Kalman_Upward_quarc_win64\rtGetNaN.c $(START_DIR)\Kalman_Upward_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Kalman_Upward.obj Kalman_Upward_data.obj Kalman_Upward_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Kalman_Upward_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Kalman_Upward_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Kalman_Upward.obj : "$(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward.c"


Kalman_Upward_data.obj : "$(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward_data.c"


Kalman_Upward_main.obj : "$(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Upward_quarc_win64\Kalman_Upward_main.c"


rtGetInf.obj : "$(START_DIR)\Kalman_Upward_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Upward_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Kalman_Upward_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Upward_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Kalman_Upward_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Upward_quarc_win64\rt_nonfinite.c"
