...
typedef struct {
  ...
  real_T Add_j[3];                     /* '<S28>/Add' */
  real_T y;                            /* '<Root>/MATLAB Function2' */
  real_T Product2[3];                  /* '<S61>/Product2' */
  real_T Product3[3];                  /* '<S59>/Product3' */
  boolean_T LogicalOperator1;          /* '<S62>/Logical Operator1' */
  boolean_T RelationalOperator2;       /* '<S62>/Relational Operator2' */
} B_Kalman_Upward_T;
...
typedef struct {
  ...
  int8_T MeasurementUpdate_SubsysRanBC;/* '<S28>/MeasurementUpdate' */
...
struct P_Kalman_Upward_T_ {
  ...
  real_T Constant1_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Switch_Threshold;             /* Expression: -0.92*pi
 ...
 * '<S7>'   : 'Kalman_Upward/Stall Detection'
 * '<S8>'   : 'Kalman_Upward/Kalman Filter/CalculatePL'
 * '<S9>'   : 'Kalman_Upward/Kalman Filter/CalculateYhat'
 * '<S10>'  : 'Kalman_Upward/Kalman Filter/CovarianceOutputConfigurator'
 * '<S11>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionA'
 * '<S12>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionB'
 * '<S13>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionC'
 * '<S14>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionD'
 * '<S15>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionEnable'
 * '<S16>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionG'
 * '<S17>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionH'
 * '<S18>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionN'
 * '<S19>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionP'
 * '<S20>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionP0'
 * '<S21>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionQ'
 * '<S22>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionR'
 * '<S23>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionReset'
 * '<S24>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionX'
 * '<S25>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionX0'
 * '<S26>'  : 'Kalman_Upward/Kalman Filter/DataTypeConversionu'
 * '<S27>'  : 'Kalman_Upward/Kalman Filter/MemoryP'
 * '<S28>'  : 'Kalman_Upward/Kalman Filter/Observer'
 * '<S29>'  : 'Kalman_Upward/Kalman Filter/ReducedQRN'
 * '<S30>'  : 'Kalman_Upward/Kalman Filter/Reset'
 * '<S31>'  : 'Kalman_Upward/Kalman Filter/Reshapeyhat'
 * '<S32>'  : 'Kalman_Upward/Kalman Filter/ScalarExpansionP0'
 * '<S33>'  : 'Kalman_Upward/Kalman Filter/ScalarExpansionQ'
 * '<S34>'  : 'Kalman_Upward/Kalman Filter/ScalarExpansionR'
 * '<S35>'  : 'Kalman_Upward/Kalman Filter/UseCurrentEstimator'
 * '<S36>'  : 'Kalman_Upward/Kalman Filter/checkA'
 * '<S37>'  : 'Kalman_Upward/Kalman Filter/checkB'
 * '<S38>'  : 'Kalman_Upward/Kalman Filter/checkC'
 * '<S39>'  : 'Kalman_Upward/Kalman Filter/checkD'
 * '<S40>'  : 'Kalman_Upward/Kalman Filter/checkEnable'
 * '<S41>'  : 'Kalman_Upward/Kalman Filter/checkG'
 * '<S42>'  : 'Kalman_Upward/Kalman Filter/checkH'
 * '<S43>'  : 'Kalman_Upward/Kalman Filter/checkN'
 * '<S44>'  : 'Kalman_Upward/Kalman Filter/checkP0'
 * '<S45>'  : 'Kalman_Upward/Kalman Filter/checkQ'
 * '<S46>'  : 'Kalman_Upward/Kalman Filter/checkR'
 * '<S47>'  : 'Kalman_Upward/Kalman Filter/checkReset'
 * '<S48>'  : 'Kalman_Upward/Kalman Filter/checkX0'
 * '<S49>'  : 'Kalman_Upward/Kalman Filter/checku'
 * '<S50>'  : 'Kalman_Upward/Kalman Filter/checky'
 * '<S51>'  : 'Kalman_Upward/Kalman Filter/CalculatePL/DataTypeConversionL'
 * '<S52>'  : 'Kalman_Upward/Kalman Filter/CalculatePL/DataTypeConversionM'
 * '<S53>'  : 'Kalman_Upward/Kalman Filter/CalculatePL/DataTypeConversionP'
 * '<S54>'  : 'Kalman_Upward/Kalman Filter/CalculatePL/DataTypeConversionZ'
 * '<S55>'  : 'Kalman_Upward/Kalman Filter/CalculatePL/Ground'
 * '<S56>'  : 'Kalman_Upward/Kalman Filter/CalculateYhat/Ground'
 * '<S57>'  : 'Kalman_Upward/Kalman Filter/CovarianceOutputConfigurator/decideOutput'
 * '<S58>'  : 'Kalman_Upward/Kalman Filter/CovarianceOutputConfigurator/decideOutput/SqrtUsedFcn'
 * '<S59>'  : 'Kalman_Upward/Kalman Filter/Observer/MeasurementUpdate'
 * '<S60>'  : 'Kalman_Upward/Kalman Filter/ReducedQRN/Ground'
 * '<S61>'  : 'Kalman_Upward/Kalman Filter/UseCurrentEstimator/Enabled Subsystem'
 * '<S62>'  : 'Kalman_Upward/Stall Detection/Stall Monitor'
 * '<S63>'  : 'Kalman_Upward/Stall Detection/Stop with Message'
 * '<S64>'  : 'Kalman_Upward/Stall Detection/Stop with Message/Compare'
 */
