 ...
 * '<S2>'   : 'Test_LQR/Radians to Degrees'
 * '<S3>'   : 'Test_LQR/Radians to Degrees1'
 * '<S4>'   : 'Test_LQR/Stall Detection'
 * '<S5>'   : 'Test_LQR/Stall Detection/Stall Monitor'
 * '<S6>'   : 'Test_LQR/Stall Detection/Stop with Message'
 * '<S7>'   : 'Test_LQR/Stall Detection/Stop with Message/Compare'
 */
