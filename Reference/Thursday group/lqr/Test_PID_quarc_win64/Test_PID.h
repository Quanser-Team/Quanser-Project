...
extern const real_T Test_PID_RGND;     /* real_T ground */
 ...
 * '<S2>'   : 'Test_PID/Radians to Degrees'
 * '<S3>'   : 'Test_PID/Radians to Degrees1'
 * '<S4>'   : 'Test_PID/Stall Detection'
 * '<S5>'   : 'Test_PID/Stall Detection/Stall Monitor'
 * '<S6>'   : 'Test_PID/Stall Detection/Stop with Message'
 * '<S7>'   : 'Test_PID/Stall Detection/Stop with Message/Compare'
 */
