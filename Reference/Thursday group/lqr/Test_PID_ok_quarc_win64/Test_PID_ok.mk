###########################################################################
## Makefile generated for component 'Test_PID_ok'. 
## 
## Makefile     : Test_PID_ok.mk
## Generated on : Tue Dec 05 17:05:25 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test_PID_ok.rt-win64
...
COMPILER_COMMAND_FILE     = Test_PID_ok_comp.rsp
CMD_FILE                  = Test_PID_ok.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test_PID_ok.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test_PID_ok -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok.c $(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok_data.c $(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok_main.c $(START_DIR)\Test_PID_ok_quarc_win64\rtGetInf.c $(START_DIR)\Test_PID_ok_quarc_win64\rtGetNaN.c $(START_DIR)\Test_PID_ok_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test_PID_ok.obj Test_PID_ok_data.obj Test_PID_ok_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test_PID_ok_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test_PID_ok_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test_PID_ok.obj : "$(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok.c"


Test_PID_ok_data.obj : "$(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok_data.c"


Test_PID_ok_main.obj : "$(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_ok_quarc_win64\Test_PID_ok_main.c"


rtGetInf.obj : "$(START_DIR)\Test_PID_ok_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_ok_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test_PID_ok_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_ok_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test_PID_ok_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_PID_ok_quarc_win64\rt_nonfinite.c"
