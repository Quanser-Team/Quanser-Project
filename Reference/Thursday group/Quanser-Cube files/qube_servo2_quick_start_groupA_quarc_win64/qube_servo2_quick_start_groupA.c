...
void qube_servo2_quick_start_groupA_output(void)
{
  ...
  if (rtmIsMajorTimeStep(qube_servo2_quick_start_grou_M)) {
    ...
    rtb_HILReadEncoder *= qube_servo2_quick_start_group_P.countstorad_Gain;
    ...
    qube_servo2_quick_start_group_B.NegativeFeedback =
      qube_servo2_quick_start_group_P.NegativeFeedback_Gain * rtb_HILReadEncoder;
  }
  ...
  if (rtmIsMajorTimeStep(qube_servo2_quick_start_grou_M)) {
    ...
    qube_servo2_quick_start_group_B.Gain[1] =
      qube_servo2_quick_start_group_P.Gain_Gain * rtb_HILReadEncoder;
    ...
    /* S-Function Block: qube_servo2_quick_start_groupA/HIL Read Encoder (hil_read_encoder_block) */
    {
      t_error result = hil_read_encoder
        (qube_servo2_quick_start_grou_DW.HILInitialize_Card,
         &qube_servo2_quick_start_group_P.HILReadEncoder_channels, 1,
    ...
    qube_servo2_quick_start_group_B.Gain_n =
      qube_servo2_quick_start_group_P.countstorad1_Gain * rtb_HILReadEncoder *
...
RT_MODEL_qube_servo2_quick_st_T *qube_servo2_quick_start_groupA(void)
{
  ...
  /* External mode info */
  qube_servo2_quick_start_grou_M->Sizes.checksums[0] = (559449422U);
  qube_servo2_quick_start_grou_M->Sizes.checksums[1] = (3165169130U);
  qube_servo2_quick_start_grou_M->Sizes.checksums[2] = (2793350665U);
  qube_servo2_quick_start_grou_M->Sizes.checksums[3] = (3145598059U);
...

  {
    ...
    qube_servo2_quick_start_group_B.Gain_n = 0.0;
  }
  ...
  qube_servo2_quick_start_grou_M->Sizes.numBlocks = (36);/* Number of blocks */
  qube_servo2_quick_start_grou_M->Sizes.numBlockIO = (9);/* Number of block outputs */
  qube_servo2_quick_start_grou_M->Sizes.numBlockPrms = (98);/* Sum of parameter "widths" */
