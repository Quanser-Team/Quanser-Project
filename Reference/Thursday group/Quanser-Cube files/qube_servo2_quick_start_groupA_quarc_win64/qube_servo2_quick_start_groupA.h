/*
 * qube_servo2_quick_start_groupA.h
 *
 ...
 * C source code generated on : Thu Sep 28 17:15:32 2023
 *
...
#ifndef RTW_HEADER_qube_servo2_quick_start_groupA_h_
#define RTW_HEADER_qube_servo2_quick_start_groupA_h_
#ifndef qube_servo2_quick_start_groupA_COMMON_INCLUDES_
#define qube_servo2_quick_start_groupA_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                     /* qube_servo2_quick_start_groupA_COMMON_INCLUDES_ */

#include "qube_servo2_quick_start_groupA_types.h"
...
#define qube_servo2_quick_start_groupA_rtModel RT_MODEL_qube_servo2_quick_st_T

/* Block signals (default storage) */
typedef struct {
  real_T SliderGain;                   /* '<S3>/Slider Gain' */
  real_T NegativeFeedback;             /* '<Root>/Negative Feedback' */
  real_T ServoVelocity;                /* '<Root>/Servo Velocity' */
...
} B_qube_servo2_quick_start_gro_T;
...
} DW_qube_servo2_quick_start_gr_T;

/* Continuous states (default storage) */
typedef struct {
  real_T ServoVelocity_CSTATE;         /* '<Root>/Servo Velocity' */
} X_qube_servo2_quick_start_gro_T;

/* State derivatives (default storage) */
typedef struct {
  real_T ServoVelocity_CSTATE;         /* '<Root>/Servo Velocity' */
} XDot_qube_servo2_quick_start__T;

/* State disabled  */
typedef struct {
  boolean_T ServoVelocity_CSTATE;      /* '<Root>/Servo Velocity' */
} XDis_qube_servo2_quick_start__T;
...
#define rtB                            qube_servo2_quick_start_group_B
#define BlockIO                        B_qube_servo2_quick_start_gro_T
#define rtX                            qube_servo2_quick_start_group_X
#define ContinuousStates               X_qube_servo2_quick_start_gro_T
#define rtXdot                         qube_servo2_quick_start_gr_XDot
#define StateDerivatives               XDot_qube_servo2_quick_start__T
#define tXdis                          qube_servo2_quick_start_gr_XDis
#define StateDisabled                  XDis_qube_servo2_quick_start__T
#define rtP                            qube_servo2_quick_start_group_P
#define Parameters                     P_qube_servo2_quick_start_gro_T
#define rtDWork                        qube_servo2_quick_start_grou_DW
#define D_Work                         DW_qube_servo2_quick_start_gr_T

/* Parameters (default storage) */
struct P_qube_servo2_quick_start_gro_T_ {
  ...
  real_T SmoothSignalGenerator_Frequency;/* Expression: i_frequency
                                          * Referenced by: '<Root>/Smooth Signal Generator'
                                          */
  real_T Amplitudedeg_Gain;            /* Expression: 65
...
struct tag_RTM_qube_servo2_quick_sta_T {
  const char_T *path;
...
extern P_qube_servo2_quick_start_gro_T qube_servo2_quick_start_group_P;

/* Block signals (default storage) */
extern B_qube_servo2_quick_start_gro_T qube_servo2_quick_start_group_B;

/* Continuous states (default storage) */
extern X_qube_servo2_quick_start_gro_T qube_servo2_quick_start_group_X;

/* Block states (default storage) */
extern DW_qube_servo2_quick_start_gr_T qube_servo2_quick_start_grou_DW;

/* Model entry point functions */
extern void qube_servo2_quick_start_groupA_initialize(void);
extern void qube_servo2_quick_start_groupA_output(void);
extern void qube_servo2_quick_start_groupA_update(void);
extern void qube_servo2_quick_start_groupA_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern qube_servo2_quick_start_groupA_rtModel *qube_servo2_quick_start_groupA
  (void);
...
extern RT_MODEL_qube_servo2_quick_st_T *const qube_servo2_quick_start_grou_M;
 ...
 *
 * '<Root>' : 'qube_servo2_quick_start_groupA'
 * '<S1>'   : 'qube_servo2_quick_start_groupA/Degrees to Radians'
 * '<S2>'   : 'qube_servo2_quick_start_groupA/Derivative Gain'
 * '<S3>'   : 'qube_servo2_quick_start_groupA/Proportional Gain'
 * '<S4>'   : 'qube_servo2_quick_start_groupA/Radians to Degrees'
 * '<S5>'   : 'qube_servo2_quick_start_groupA/Radians to Degrees1'
 * '<S6>'   : 'qube_servo2_quick_start_groupA/Stall Detection'
 * '<S7>'   : 'qube_servo2_quick_start_groupA/Stall Detection/Stall Monitor'
 * '<S8>'   : 'qube_servo2_quick_start_groupA/Stall Detection/Stop with Message'
 * '<S9>'   : 'qube_servo2_quick_start_groupA/Stall Detection/Stop with Message/Compare'
 */
#endif                        /* RTW_HEADER_qube_servo2_quick_start_groupA_h_ */
