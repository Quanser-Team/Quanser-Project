...
#ifndef RTW_HEADER_Swingup_test_h_
#define RTW_HEADER_Swingup_test_h_
#ifndef Swingup_test_COMMON_INCLUDES_
#define Swingup_test_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Swingup_test_COMMON_INCLUDES_ */
...
#define Swingup_test_rtModel           RT_MODEL_Swingup_test_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } MotorVoltageV1_PWORK;              /* '<Root>/Motor Voltage (V)1' */
...
#define rtB                            Swingup_test_B
#define BlockIO                        B_Swingup_test_T
#define rtX                            Swingup_test_X
#define ContinuousStates               X_Swingup_test_T
#define rtXdot                         Swingup_test_XDot
#define StateDerivatives               XDot_Swingup_test_T
#define tXdis                          Swingup_test_XDis
#define StateDisabled                  XDis_Swingup_test_T
#define rtP                            Swingup_test_P
#define Parameters                     P_Swingup_test_T
#define rtDWork                        Swingup_test_DW
#define D_Work                         DW_Swingup_test_T

/* Parameters (default storage) */
struct P_Swingup_test_T_ {
  ...
  real_T Constant1_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Switch_Threshold;             /* Expression: 0.85*pi
                                        * Referenced by: '<Root>/Switch'
                                        */
  real_T Gain2_Gain;                   /* Expression: 1
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T Saturation1_UpperSat;         /* Expression: 5.5
                                        * Referenced by: '<Root>/Saturation1'
                                        */
  real_T Saturation1_LowerSat;         /* Expression: -5.5
                                        * Referenced by: '<Root>/Saturation1'
                                        */
...
extern P_Swingup_test_T Swingup_test_P;

/* Block signals (default storage) */
extern B_Swingup_test_T Swingup_test_B;

/* Continuous states (default storage) */
extern X_Swingup_test_T Swingup_test_X;

/* Block states (default storage) */
extern DW_Swingup_test_T Swingup_test_DW;

/* Model entry point functions */
extern void Swingup_test_initialize(void);
extern void Swingup_test_output(void);
extern void Swingup_test_update(void);
extern void Swingup_test_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Swingup_test_rtModel *Swingup_test(void);
...
extern RT_MODEL_Swingup_test_T *const Swingup_test_M;
 ...
 *
 * '<Root>' : 'Swingup_test'
 * '<S1>'   : 'Swingup_test/Degrees to Radians'
 * '<S2>'   : 'Swingup_test/Radians to Degrees'
 * '<S3>'   : 'Swingup_test/Radians to Degrees1'
 * '<S4>'   : 'Swingup_test/Stall Detection'
 * '<S5>'   : 'Swingup_test/Stall Detection/Stall Monitor'
 * '<S6>'   : 'Swingup_test/Stall Detection/Stop with Message'
 * '<S7>'   : 'Swingup_test/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Swingup_test_h_ */
