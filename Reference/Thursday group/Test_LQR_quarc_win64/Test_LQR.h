 ...
 * C source code generated on : Thu Dec 14 17:51:04 2023
 *
...
#ifndef RTW_HEADER_Test_LQR_h_
#define RTW_HEADER_Test_LQR_h_
#ifndef Test_LQR_COMMON_INCLUDES_
#define Test_LQR_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Test_LQR_COMMON_INCLUDES_ */

#include "Test_LQR_types.h"
...
#define Test_LQR_rtModel               RT_MODEL_Test_LQR_T
...
typedef struct {
  ...
  boolean_T RelationalOperator2;       /* '<S4>/Relational Operator2' */
} B_Test_LQR_T;
...
#define rtB                            Test_LQR_B
#define BlockIO                        B_Test_LQR_T
#define rtX                            Test_LQR_X
#define ContinuousStates               X_Test_LQR_T
#define rtXdot                         Test_LQR_XDot
#define StateDerivatives               XDot_Test_LQR_T
#define tXdis                          Test_LQR_XDis
#define StateDisabled                  XDis_Test_LQR_T
#define rtP                            Test_LQR_P
#define Parameters                     P_Test_LQR_T
#define rtDWork                        Test_LQR_DW
#define D_Work                         DW_Test_LQR_T

/* Parameters (default storage) */
struct P_Test_LQR_T_ {
  real_T K_pp[4];                      /* Variable: K_pp
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T StallMonitor_control_threshold;
                               /* Mask Parameter: StallMonitor_control_threshold
                                * Referenced by: '<S4>/control threshold'
                                */
  real_T StallMonitor_duration_s;     /* Mask Parameter: StallMonitor_duration_s
                                       * Referenced by: '<S4>/control threshold1'
                                       */
  real_T StallMonitor_motion_threshold;
                                /* Mask Parameter: StallMonitor_motion_threshold
                                 * Referenced by: '<S4>/motion threshold'
                                 */
  ...
  real_T Step_YFinal;                  /* Expression: 5
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step1_Time;                   /* Expression: 5.1
...
extern P_Test_LQR_T Test_LQR_P;

/* Block signals (default storage) */
extern B_Test_LQR_T Test_LQR_B;

/* Continuous states (default storage) */
extern X_Test_LQR_T Test_LQR_X;

/* Block states (default storage) */
extern DW_Test_LQR_T Test_LQR_DW;

/* Model entry point functions */
extern void Test_LQR_initialize(void);
extern void Test_LQR_output(void);
extern void Test_LQR_update(void);
extern void Test_LQR_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Test_LQR_rtModel *Test_LQR(void);
...
extern RT_MODEL_Test_LQR_T *const Test_LQR_M;
 ...
 *
 * '<Root>' : 'Test_LQR'
 * '<S1>'   : 'Test_LQR/Degrees to Radians'
 * '<S2>'   : 'Test_LQR/Radians to Degrees1'
 * '<S3>'   : 'Test_LQR/Stall Detection'
 * '<S4>'   : 'Test_LQR/Stall Detection/Stall Monitor'
 * '<S5>'   : 'Test_LQR/Stall Detection/Stop with Message'
 * '<S6>'   : 'Test_LQR/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Test_LQR_h_ */
