...
void Test_LQR_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Test_LQR_M)) {
     ...
     */
    Test_LQR_B.Gain1 = Test_LQR_P.Gain1_Gain * Test_LQR_P.Constant_Value;
  }
   ...
   *  Step: '<Root>/Step1'
   */
  rtb_HILReadEncoderTimebase = Test_LQR_M->Timing.t[0];
  if (rtb_HILReadEncoderTimebase < Test_LQR_P.Step_Time) {
    rtb_DiscreteTimeIntegrator = Test_LQR_P.Step_Y0;
  } else {
    rtb_DiscreteTimeIntegrator = Test_LQR_P.Step_YFinal;
  }

  /* Step: '<Root>/Step1' */
  if (rtb_HILReadEncoderTimebase < Test_LQR_P.Step1_Time) {
    rtb_HILReadEncoderTimebase = Test_LQR_P.Step1_Y0;
  } else {
    rtb_HILReadEncoderTimebase = Test_LQR_P.Step1_YFinal;
  }
   ...
   *  Step: '<Root>/Step1'
   */
  rtb_HILReadEncoderTimebase = (Test_LQR_B.Switch + rtb_DiscreteTimeIntegrator)
    - rtb_HILReadEncoderTimebase;
  ...
  if (rtmIsMajorTimeStep(Test_LQR_M)) {
     ...
     */
    if (Test_LQR_B.RelationalOperator2 != Test_LQR_P.Constant_Value_j) {
...
RT_MODEL_Test_LQR_T *Test_LQR(void)
{
  ...
  /* External mode info */
  Test_LQR_M->Sizes.checksums[0] = (308594842U);
  Test_LQR_M->Sizes.checksums[1] = (397398328U);
  Test_LQR_M->Sizes.checksums[2] = (4097246295U);
  Test_LQR_M->Sizes.checksums[3] = (1131854943U);
  ...
  Test_LQR_M->Sizes.numBlocks = (52);  /* Number of blocks */
  Test_LQR_M->Sizes.numBlockIO = (13); /* Number of block outputs */
  Test_LQR_M->Sizes.numBlockPrms = (111);/* Sum of parameter "widths" */
  return Test_LQR_M;
}
