    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (Test_LQR_Luenberger_P)
        ;%
            section.nData     = 5;
            section.data(5)  = dumData; %prealloc

                    ;% Test_LQR_Luenberger_P.K_pp
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_LQR_Luenberger_P.ic
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_P.HILReadEncoder_channels
                    section.data(1).logicalSrcIdx = 5;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_LQR_Luenberger_P.HILWriteAnalog_channels
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_P.StopwithMessage_message_icon
            ...
            section.data(45)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_P.HILInitialize_OOTerminate
                    section.data(1).logicalSrcIdx = 8;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_LQR_Luenberger_P.HILInitialize_OOExit
                    section.data(2).logicalSrcIdx = 9;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_LQR_Luenberger_P.HILInitialize_OOStart
                    section.data(3).logicalSrcIdx = 10;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_LQR_Luenberger_P.HILInitialize_OOEnter
                    ...
                    ;% Test_LQR_Luenberger_P.countstorad1_Gain
                    section.data(15).logicalSrcIdx = 22;
                    section.data(15).dtTransOffset = 20;

                    ;% Test_LQR_Luenberger_P.TransferFcn1_A
                    section.data(16).logicalSrcIdx = 23;
                    section.data(16).dtTransOffset = 21;

                    ;% Test_LQR_Luenberger_P.TransferFcn1_C
                    section.data(17).logicalSrcIdx = 24;
                    section.data(17).dtTransOffset = 22;

                    ;% Test_LQR_Luenberger_P.TransferFcn1_D
                    ...
                    ;% Test_LQR_Luenberger_P.Gain1_Gain
                    ...
                    ;% Test_LQR_Luenberger_P.countstorad_Gain
                    section.data(22).logicalSrcIdx = 29;
                    section.data(22).dtTransOffset = 27;

                    ;% Test_LQR_Luenberger_P.TransferFcn_A
                    section.data(23).logicalSrcIdx = 30;
                    section.data(23).dtTransOffset = 28;

                    ;% Test_LQR_Luenberger_P.TransferFcn_C
                    section.data(24).logicalSrcIdx = 31;
                    section.data(24).dtTransOffset = 29;

                    ;% Test_LQR_Luenberger_P.TransferFcn_D
                    ...
                    ;% Test_LQR_Luenberger_P.Gain1_Gain_a
                    section.data(27).logicalSrcIdx = 34;
                    section.data(27).dtTransOffset = 32;

                    ;% Test_LQR_Luenberger_P.Saturation_UpperSat
                    ...
                    ;% Test_LQR_Luenberger_P.Constant1_Value
                    ...
                    ;% Test_LQR_Luenberger_P.Gain_Gain_k
                    section.data(34).logicalSrcIdx = 41;
                    section.data(34).dtTransOffset = 39;

                    ;% Test_LQR_Luenberger_P.Gain_Gain_a
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_P.HILInitialize_CKChannels
                    section.data(1).logicalSrcIdx = 53;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOWatchdog
                    ...
                    ;% Test_LQR_Luenberger_P.HILReadEncoderTimebase_Clock
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_P.HILInitialize_AIChannels
                    ...
                    ;% Test_LQR_Luenberger_P.HILInitialize_EIChannels
                    ...
                    ;% Test_LQR_Luenberger_P.HILReadEncoderTimebase_Channels
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_P.HILInitialize_Active
                    section.data(2).logicalSrcIdx = 66;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AOTerminate
                    section.data(3).logicalSrcIdx = 67;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AOExit
                    section.data(4).logicalSrcIdx = 68;
                    section.data(4).dtTransOffset = 3;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOTerminate
                    section.data(5).logicalSrcIdx = 69;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOExit
                    section.data(6).logicalSrcIdx = 70;
                    section.data(6).dtTransOffset = 5;

                    ;% Test_LQR_Luenberger_P.HILInitialize_POTerminate
                    section.data(7).logicalSrcIdx = 71;
                    section.data(7).dtTransOffset = 6;

                    ;% Test_LQR_Luenberger_P.HILInitialize_POExit
                    section.data(8).logicalSrcIdx = 72;
                    section.data(8).dtTransOffset = 7;

                    ;% Test_LQR_Luenberger_P.HILInitialize_CKPStart
                    section.data(9).logicalSrcIdx = 73;
                    section.data(9).dtTransOffset = 8;

                    ;% Test_LQR_Luenberger_P.HILInitialize_CKPEnter
                    section.data(10).logicalSrcIdx = 74;
                    section.data(10).dtTransOffset = 9;

                    ;% Test_LQR_Luenberger_P.HILInitialize_CKStart
                    section.data(11).logicalSrcIdx = 75;
                    section.data(11).dtTransOffset = 10;

                    ;% Test_LQR_Luenberger_P.HILInitialize_CKEnter
                    section.data(12).logicalSrcIdx = 76;
                    section.data(12).dtTransOffset = 11;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AIPStart
                    section.data(13).logicalSrcIdx = 77;
                    section.data(13).dtTransOffset = 12;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AIPEnter
                    section.data(14).logicalSrcIdx = 78;
                    section.data(14).dtTransOffset = 13;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AOPStart
                    section.data(15).logicalSrcIdx = 79;
                    section.data(15).dtTransOffset = 14;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AOPEnter
                    section.data(16).logicalSrcIdx = 80;
                    section.data(16).dtTransOffset = 15;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AOStart
                    section.data(17).logicalSrcIdx = 81;
                    section.data(17).dtTransOffset = 16;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AOEnter
                    section.data(18).logicalSrcIdx = 82;
                    section.data(18).dtTransOffset = 17;

                    ;% Test_LQR_Luenberger_P.HILInitialize_AOReset
                    section.data(19).logicalSrcIdx = 83;
                    section.data(19).dtTransOffset = 18;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOPStart
                    section.data(20).logicalSrcIdx = 84;
                    section.data(20).dtTransOffset = 19;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOPEnter
                    section.data(21).logicalSrcIdx = 85;
                    section.data(21).dtTransOffset = 20;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOStart
                    section.data(22).logicalSrcIdx = 86;
                    section.data(22).dtTransOffset = 21;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOEnter
                    section.data(23).logicalSrcIdx = 87;
                    section.data(23).dtTransOffset = 22;

                    ;% Test_LQR_Luenberger_P.HILInitialize_DOReset
                    section.data(24).logicalSrcIdx = 88;
                    section.data(24).dtTransOffset = 23;

                    ;% Test_LQR_Luenberger_P.HILInitialize_EIPStart
                    section.data(25).logicalSrcIdx = 89;
                    section.data(25).dtTransOffset = 24;

                    ;% Test_LQR_Luenberger_P.HILInitialize_EIPEnter
                    section.data(26).logicalSrcIdx = 90;
                    section.data(26).dtTransOffset = 25;

                    ;% Test_LQR_Luenberger_P.HILInitialize_EIStart
                    section.data(27).logicalSrcIdx = 91;
                    section.data(27).dtTransOffset = 26;

                    ;% Test_LQR_Luenberger_P.HILInitialize_EIEnter
                    section.data(28).logicalSrcIdx = 92;
                    section.data(28).dtTransOffset = 27;

                    ;% Test_LQR_Luenberger_P.HILInitialize_POPStart
                    section.data(29).logicalSrcIdx = 93;
                    section.data(29).dtTransOffset = 28;

                    ;% Test_LQR_Luenberger_P.HILInitialize_POPEnter
                    section.data(30).logicalSrcIdx = 94;
                    section.data(30).dtTransOffset = 29;

                    ;% Test_LQR_Luenberger_P.HILInitialize_POStart
                    section.data(31).logicalSrcIdx = 95;
                    section.data(31).dtTransOffset = 30;

                    ;% Test_LQR_Luenberger_P.HILInitialize_POEnter
                    section.data(32).logicalSrcIdx = 96;
                    section.data(32).dtTransOffset = 31;

                    ;% Test_LQR_Luenberger_P.HILInitialize_POReset
                    section.data(33).logicalSrcIdx = 97;
                    section.data(33).dtTransOffset = 32;

                    ;% Test_LQR_Luenberger_P.HILInitialize_OOReset
                    ...
                    ;% Test_LQR_Luenberger_P.HILReadEncoderTimebase_Active
                    section.data(37).logicalSrcIdx = 101;
                    section.data(37).dtTransOffset = 36;

                    ;% Test_LQR_Luenberger_P.HILReadEncoder_Active
                    section.data(38).logicalSrcIdx = 102;
                    section.data(38).dtTransOffset = 37;

                    ;% Test_LQR_Luenberger_P.HILWriteAnalog_Active
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_P.HILReadEncoderTimebase_Overflow
    ...
    ;%**************************
        ...
        ;%
        ;% Auto data (Test_LQR_Luenberger_B)
        ;%
            section.nData     = 18;
            section.data(18)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_B.Add
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 6;

                    ;% Test_LQR_Luenberger_B.Saturation
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 7;

                    ;% Test_LQR_Luenberger_B.Switch
                    ...
                    ;% Test_LQR_Luenberger_B.Gain_n
                    section.data(11).logicalSrcIdx = 10;
                    section.data(11).dtTransOffset = 10;

                    ;% Test_LQR_Luenberger_B.Gain_f
                    ...
                    ;% Test_LQR_Luenberger_B.Admatrix
                    section.data(14).logicalSrcIdx = 13;
                    section.data(14).dtTransOffset = 14;

                    ;% Test_LQR_Luenberger_B.Cdmatrix
                    section.data(15).logicalSrcIdx = 14;
                    section.data(15).dtTransOffset = 18;

                    ;% Test_LQR_Luenberger_B.Sum3
                    section.data(16).logicalSrcIdx = 15;
                    section.data(16).dtTransOffset = 22;

                    ;% Test_LQR_Luenberger_B.y
                    section.data(17).logicalSrcIdx = 16;
                    section.data(17).dtTransOffset = 26;

                    ;% Test_LQR_Luenberger_B.y_i
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_B.RelationalOperator2
    ...
    ;%*******************
        ...
        ;%
        ;% Auto data (Test_LQR_Luenberger_DW)
        ;%
            section.nData     = 3;
            section.data(3)  = dumData; %prealloc

                    ;% Test_LQR_Luenberger_DW.UnitDelay_DSTATE
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;
                    ...
                    ;% Test_LQR_Luenberger_DW.HILInitialize_FilterFrequency
                    section.data(3).logicalSrcIdx = 2;
            ...
            section.data(14)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_DW.HILReadEncoder_PWORK
                    section.data(1).logicalSrcIdx = 6;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_LQR_Luenberger_DW.HILWriteAnalog_PWORK
                    section.data(2).logicalSrcIdx = 7;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_LQR_Luenberger_DW.MotorVoltageV_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 8;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_LQR_Luenberger_DW.PendAngledeg1_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 9;
                    section.data(4).dtTransOffset = 3;

                    ;% Test_LQR_Luenberger_DW.Scope_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 10;
                    section.data(5).dtTransOffset = 4;

                    ;% Test_LQR_Luenberger_DW.Scope1_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 11;
                    section.data(6).dtTransOffset = 5;

                    ;% Test_LQR_Luenberger_DW.ServoAngledeg_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 12;
                    section.data(7).dtTransOffset = 6;

                    ;% Test_LQR_Luenberger_DW.ToWorkspace_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 13;
                    section.data(8).dtTransOffset = 7;

                    ;% Test_LQR_Luenberger_DW.ToWorkspace1_PWORK.LoggedData
                    section.data(9).logicalSrcIdx = 14;
                    section.data(9).dtTransOffset = 8;

                    ;% Test_LQR_Luenberger_DW.ToWorkspace2_PWORK.LoggedData
                    section.data(10).logicalSrcIdx = 15;
                    section.data(10).dtTransOffset = 9;

                    ;% Test_LQR_Luenberger_DW.ToWorkspace3_PWORK.LoggedData
                    section.data(11).logicalSrcIdx = 16;
                    section.data(11).dtTransOffset = 10;

                    ;% Test_LQR_Luenberger_DW.ToWorkspace4_PWORK.LoggedData
                    section.data(12).logicalSrcIdx = 17;
                    section.data(12).dtTransOffset = 11;

                    ;% Test_LQR_Luenberger_DW.ToWorkspace5_PWORK.LoggedData
                    section.data(13).logicalSrcIdx = 18;
                    section.data(13).dtTransOffset = 12;

                    ;% Test_LQR_Luenberger_DW.ToWorkspace6_PWORK.LoggedData
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_DW.HILInitialize_ClockModes
                    section.data(1).logicalSrcIdx = 20;
                    section.data(1).dtTransOffset = 0;

                    ;% Test_LQR_Luenberger_DW.HILInitialize_DOStates
                    section.data(2).logicalSrcIdx = 21;
                    section.data(2).dtTransOffset = 1;

                    ;% Test_LQR_Luenberger_DW.HILInitialize_QuadratureModes
                    section.data(3).logicalSrcIdx = 22;
                    section.data(3).dtTransOffset = 2;

                    ;% Test_LQR_Luenberger_DW.HILInitialize_InitialEICounts
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Test_LQR_Luenberger_DW.DiscreteTimeIntegrator_PrevRese
    ...
    targMap.checksum0 = 670533507;
    targMap.checksum1 = 3292580216;
    targMap.checksum2 = 2513771312;
    targMap.checksum3 = 422488339;
