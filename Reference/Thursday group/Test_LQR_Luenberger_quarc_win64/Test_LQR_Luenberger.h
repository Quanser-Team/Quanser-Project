...
#ifndef RTW_HEADER_Test_LQR_Luenberger_h_
#define RTW_HEADER_Test_LQR_Luenberger_h_
#ifndef Test_LQR_Luenberger_COMMON_INCLUDES_
#define Test_LQR_Luenberger_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                /* Test_LQR_Luenberger_COMMON_INCLUDES_ */

#include "Test_LQR_Luenberger_types.h"
...
#define Test_LQR_Luenberger_rtModel    RT_MODEL_Test_LQR_Luenberger_T
...
#define rtB                            Test_LQR_Luenberger_B
#define BlockIO                        B_Test_LQR_Luenberger_T
#define rtX                            Test_LQR_Luenberger_X
#define ContinuousStates               X_Test_LQR_Luenberger_T
#define rtXdot                         Test_LQR_Luenberger_XDot
#define StateDerivatives               XDot_Test_LQR_Luenberger_T
#define tXdis                          Test_LQR_Luenberger_XDis
#define StateDisabled                  XDis_Test_LQR_Luenberger_T
#define rtP                            Test_LQR_Luenberger_P
#define Parameters                     P_Test_LQR_Luenberger_T
#define rtDWork                        Test_LQR_Luenberger_DW
#define D_Work                         DW_Test_LQR_Luenberger_T

/* Parameters (default storage) */
struct P_Test_LQR_Luenberger_T_ {
  real_T K_pp[4];                      /* Variable: K_pp
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T ic[4];                        /* Variable: ic
  ...
  real_T Constant1_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Switch_Threshold;             /* Expression: 0.95*pi
  ...
  real_T DiscreteTimeIntegrator_IC;    /* Expression: 0
                                        * Referenced by: '<S9>/Discrete-Time Integrator'
                                        */
  real_T Admatrix_Gain[16];            /* Expression: Ad
                                        * Referenced by: '<S2>/Ad matrix'
                                        */
  real_T Bdmatrix_Gain[4];             /* Expression: Bd
                                        * Referenced by: '<S2>/Bd matrix'
                                        */
  real_T Cdmatrix_Gain[16];            /* Expression: Cd
                                        * Referenced by: '<S2>/Cd matrix'
                                        */
  real_T Ddmatrix_Gain[4];             /* Expression: Dd
                                        * Referenced by: '<S2>/Dd matrix'
                                        */
  real_T Ldmatrix_Gain[16];            /* Expression: Ld
...
struct tag_RTM_Test_LQR_Luenberger_T {
  const char_T *path;
...
extern P_Test_LQR_Luenberger_T Test_LQR_Luenberger_P;

/* Block signals (default storage) */
extern B_Test_LQR_Luenberger_T Test_LQR_Luenberger_B;

/* Continuous states (default storage) */
extern X_Test_LQR_Luenberger_T Test_LQR_Luenberger_X;

/* Block states (default storage) */
extern DW_Test_LQR_Luenberger_T Test_LQR_Luenberger_DW;

/* Model entry point functions */
extern void Test_LQR_Luenberger_initialize(void);
extern void Test_LQR_Luenberger_output(void);
extern void Test_LQR_Luenberger_update(void);
extern void Test_LQR_Luenberger_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Test_LQR_Luenberger_rtModel *Test_LQR_Luenberger(void);
...
extern RT_MODEL_Test_LQR_Luenberger_T *const Test_LQR_Luenberger_M;
 ...
 *
 * '<Root>' : 'Test_LQR_Luenberger'
 * '<S1>'   : 'Test_LQR_Luenberger/Degrees to Radians'
 * '<S2>'   : 'Test_LQR_Luenberger/Luenberger Observer'
 * '<S3>'   : 'Test_LQR_Luenberger/MATLAB Function'
 * '<S4>'   : 'Test_LQR_Luenberger/MATLAB Function1'
 * '<S5>'   : 'Test_LQR_Luenberger/MATLAB Function2'
 * '<S6>'   : 'Test_LQR_Luenberger/Radians to Degrees'
 * '<S7>'   : 'Test_LQR_Luenberger/Radians to Degrees1'
 * '<S8>'   : 'Test_LQR_Luenberger/Stall Detection'
 * '<S9>'   : 'Test_LQR_Luenberger/Stall Detection/Stall Monitor'
 * '<S10>'  : 'Test_LQR_Luenberger/Stall Detection/Stop with Message'
 * '<S11>'  : 'Test_LQR_Luenberger/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Test_LQR_Luenberger_h_ */
