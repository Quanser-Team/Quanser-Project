###########################################################################
## Makefile generated for component 'Test_LQR_Luenberger'. 
## 
## Makefile     : Test_LQR_Luenberger.mk
## Generated on : Tue Nov 28 14:40:40 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Test_LQR_Luenberger.rt-win64
...
PRODUCT_NAME              = Test_LQR_Luenberger
MAKEFILE                  = Test_LQR_Luenberger.mk
...
COMPILER_COMMAND_FILE     = Test_LQR_Luenberger_comp.rsp
CMD_FILE                  = Test_LQR_Luenberger.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Test_LQR_Luenberger.rt-win64
...
DEFINES_STANDARD = -DMODEL=Test_LQR_Luenberger -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger.c $(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger_data.c $(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger_main.c $(START_DIR)\Test_LQR_Luenberger_quarc_win64\rtGetInf.c $(START_DIR)\Test_LQR_Luenberger_quarc_win64\rtGetNaN.c $(START_DIR)\Test_LQR_Luenberger_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Test_LQR_Luenberger.obj Test_LQR_Luenberger_data.obj Test_LQR_Luenberger_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Test_LQR_Luenberger_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Test_LQR_Luenberger_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Test_LQR_Luenberger.obj : "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger.c"


Test_LQR_Luenberger_data.obj : "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger_data.c"


Test_LQR_Luenberger_main.obj : "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\Test_LQR_Luenberger_main.c"


rtGetInf.obj : "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Test_LQR_Luenberger_quarc_win64\rt_nonfinite.c"
