###########################################################################
## Makefile generated for component 'Swingup_energy'. 
## 
## Makefile     : Swingup_energy.mk
## Generated on : Tue Dec 05 14:44:45 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Swingup_energy.rt-win64
...
COMPILER_COMMAND_FILE     = Swingup_energy_comp.rsp
CMD_FILE                  = Swingup_energy.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Swingup_energy.rt-win64
...
DEFINES_STANDARD = -DMODEL=Swingup_energy -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy.c $(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy_data.c $(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy_main.c $(START_DIR)\Swingup_energy_quarc_win64\rtGetInf.c $(START_DIR)\Swingup_energy_quarc_win64\rtGetNaN.c $(START_DIR)\Swingup_energy_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Swingup_energy.obj Swingup_energy_data.obj Swingup_energy_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Swingup_energy_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Swingup_energy_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Swingup_energy.obj : "$(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy.c"


Swingup_energy_data.obj : "$(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy_data.c"


Swingup_energy_main.obj : "$(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_quarc_win64\Swingup_energy_main.c"


rtGetInf.obj : "$(START_DIR)\Swingup_energy_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Swingup_energy_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Swingup_energy_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Swingup_energy_quarc_win64\rt_nonfinite.c"
