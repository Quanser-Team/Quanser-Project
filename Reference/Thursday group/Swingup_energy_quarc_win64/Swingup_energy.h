...
#ifndef RTW_HEADER_Swingup_energy_h_
#define RTW_HEADER_Swingup_energy_h_
#ifndef Swingup_energy_COMMON_INCLUDES_
#define Swingup_energy_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Swingup_energy_COMMON_INCLUDES_ */

#include "Swingup_energy_types.h"
#include "rtGetNaN.h"
...
#define Swingup_energy_rtModel         RT_MODEL_Swingup_energy_T
...
#define rtB                            Swingup_energy_B
#define BlockIO                        B_Swingup_energy_T
#define rtX                            Swingup_energy_X
#define ContinuousStates               X_Swingup_energy_T
#define rtXdot                         Swingup_energy_XDot
#define StateDerivatives               XDot_Swingup_energy_T
#define tXdis                          Swingup_energy_XDis
#define StateDisabled                  XDis_Swingup_energy_T
#define rtP                            Swingup_energy_P
#define Parameters                     P_Swingup_energy_T
#define rtDWork                        Swingup_energy_DW
#define D_Work                         DW_Swingup_energy_T

/* Parameters (default storage) */
struct P_Swingup_energy_T_ {
...
struct tag_RTM_Swingup_energy_T {
  const char_T *path;
...
extern P_Swingup_energy_T Swingup_energy_P;

/* Block signals (default storage) */
extern B_Swingup_energy_T Swingup_energy_B;

/* Continuous states (default storage) */
extern X_Swingup_energy_T Swingup_energy_X;

/* Block states (default storage) */
extern DW_Swingup_energy_T Swingup_energy_DW;

/* Model entry point functions */
extern void Swingup_energy_initialize(void);
extern void Swingup_energy_output(void);
extern void Swingup_energy_update(void);
extern void Swingup_energy_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Swingup_energy_rtModel *Swingup_energy(void);
...
extern RT_MODEL_Swingup_energy_T *const Swingup_energy_M;
 ...
 *
 * '<Root>' : 'Swingup_energy'
 * '<S1>'   : 'Swingup_energy/Degrees to Radians'
 * '<S2>'   : 'Swingup_energy/MATLAB Function'
 * '<S3>'   : 'Swingup_energy/MATLAB Function1'
 * '<S4>'   : 'Swingup_energy/MATLAB Function2'
 * '<S5>'   : 'Swingup_energy/MATLAB Function3'
 * '<S6>'   : 'Swingup_energy/Radians to Degrees'
 * '<S7>'   : 'Swingup_energy/Radians to Degrees1'
 * '<S8>'   : 'Swingup_energy/Stall Detection'
 * '<S9>'   : 'Swingup_energy/Stall Detection/Stall Monitor'
 * '<S10>'  : 'Swingup_energy/Stall Detection/Stop with Message'
 * '<S11>'  : 'Swingup_energy/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Swingup_energy_h_ */
