    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (Swingup_energy_P)
        ;%
            section.nData     = 4;
            section.data(4)  = dumData; %prealloc

                    ;% Swingup_energy_P.K_pp
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_P.HILReadEncoder_channels
                    section.data(1).logicalSrcIdx = 4;
                    section.data(1).dtTransOffset = 0;

                    ;% Swingup_energy_P.HILWriteAnalog_channels
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_P.StopwithMessage_message_icon
            ...
            section.data(41)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_P.Saturation2_UpperSat
                    ...
                    ;% Swingup_energy_P.HILInitialize_OOTerminate
                    section.data(3).logicalSrcIdx = 9;
                    section.data(3).dtTransOffset = 2;

                    ;% Swingup_energy_P.HILInitialize_OOExit
                    section.data(4).logicalSrcIdx = 10;
                    section.data(4).dtTransOffset = 3;

                    ;% Swingup_energy_P.HILInitialize_OOStart
                    section.data(5).logicalSrcIdx = 11;
                    section.data(5).dtTransOffset = 4;

                    ;% Swingup_energy_P.HILInitialize_OOEnter
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_P.HILInitialize_CKChannels
                    ...
                    ;% Swingup_energy_P.HILReadEncoderTimebase_Clock
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_P.HILInitialize_AIChannels
                    ...
                    ;% Swingup_energy_P.HILInitialize_EIChannels
                    ...
                    ;% Swingup_energy_P.HILReadEncoderTimebase_Channels
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_P.Constant_Value
                    section.data(1).logicalSrcIdx = 60;
                    section.data(1).dtTransOffset = 0;

                    ;% Swingup_energy_P.HILInitialize_Active
                    section.data(2).logicalSrcIdx = 61;
                    section.data(2).dtTransOffset = 1;

                    ;% Swingup_energy_P.HILInitialize_AOTerminate
                    section.data(3).logicalSrcIdx = 62;
                    section.data(3).dtTransOffset = 2;

                    ;% Swingup_energy_P.HILInitialize_AOExit
                    section.data(4).logicalSrcIdx = 63;
                    section.data(4).dtTransOffset = 3;

                    ;% Swingup_energy_P.HILInitialize_DOTerminate
                    section.data(5).logicalSrcIdx = 64;
                    section.data(5).dtTransOffset = 4;

                    ;% Swingup_energy_P.HILInitialize_DOExit
                    section.data(6).logicalSrcIdx = 65;
                    section.data(6).dtTransOffset = 5;

                    ;% Swingup_energy_P.HILInitialize_POTerminate
                    section.data(7).logicalSrcIdx = 66;
                    section.data(7).dtTransOffset = 6;

                    ;% Swingup_energy_P.HILInitialize_POExit
                    section.data(8).logicalSrcIdx = 67;
                    section.data(8).dtTransOffset = 7;

                    ;% Swingup_energy_P.HILInitialize_CKPStart
                    section.data(9).logicalSrcIdx = 68;
                    section.data(9).dtTransOffset = 8;

                    ;% Swingup_energy_P.HILInitialize_CKPEnter
                    section.data(10).logicalSrcIdx = 69;
                    section.data(10).dtTransOffset = 9;

                    ;% Swingup_energy_P.HILInitialize_CKStart
                    section.data(11).logicalSrcIdx = 70;
                    section.data(11).dtTransOffset = 10;

                    ;% Swingup_energy_P.HILInitialize_CKEnter
                    section.data(12).logicalSrcIdx = 71;
                    section.data(12).dtTransOffset = 11;

                    ;% Swingup_energy_P.HILInitialize_AIPStart
                    section.data(13).logicalSrcIdx = 72;
                    section.data(13).dtTransOffset = 12;

                    ;% Swingup_energy_P.HILInitialize_AIPEnter
                    section.data(14).logicalSrcIdx = 73;
                    section.data(14).dtTransOffset = 13;

                    ;% Swingup_energy_P.HILInitialize_AOPStart
                    section.data(15).logicalSrcIdx = 74;
                    section.data(15).dtTransOffset = 14;

                    ;% Swingup_energy_P.HILInitialize_AOPEnter
                    section.data(16).logicalSrcIdx = 75;
                    section.data(16).dtTransOffset = 15;

                    ;% Swingup_energy_P.HILInitialize_AOStart
                    section.data(17).logicalSrcIdx = 76;
                    section.data(17).dtTransOffset = 16;

                    ;% Swingup_energy_P.HILInitialize_AOEnter
                    section.data(18).logicalSrcIdx = 77;
                    section.data(18).dtTransOffset = 17;

                    ;% Swingup_energy_P.HILInitialize_AOReset
                    section.data(19).logicalSrcIdx = 78;
                    section.data(19).dtTransOffset = 18;

                    ;% Swingup_energy_P.HILInitialize_DOPStart
                    section.data(20).logicalSrcIdx = 79;
                    section.data(20).dtTransOffset = 19;

                    ;% Swingup_energy_P.HILInitialize_DOPEnter
                    section.data(21).logicalSrcIdx = 80;
                    section.data(21).dtTransOffset = 20;

                    ;% Swingup_energy_P.HILInitialize_DOStart
                    section.data(22).logicalSrcIdx = 81;
                    section.data(22).dtTransOffset = 21;

                    ;% Swingup_energy_P.HILInitialize_DOEnter
                    section.data(23).logicalSrcIdx = 82;
                    section.data(23).dtTransOffset = 22;

                    ;% Swingup_energy_P.HILInitialize_DOReset
                    section.data(24).logicalSrcIdx = 83;
                    section.data(24).dtTransOffset = 23;

                    ;% Swingup_energy_P.HILInitialize_EIPStart
                    section.data(25).logicalSrcIdx = 84;
                    section.data(25).dtTransOffset = 24;

                    ;% Swingup_energy_P.HILInitialize_EIPEnter
                    section.data(26).logicalSrcIdx = 85;
                    section.data(26).dtTransOffset = 25;

                    ;% Swingup_energy_P.HILInitialize_EIStart
                    section.data(27).logicalSrcIdx = 86;
                    section.data(27).dtTransOffset = 26;

                    ;% Swingup_energy_P.HILInitialize_EIEnter
                    section.data(28).logicalSrcIdx = 87;
                    section.data(28).dtTransOffset = 27;

                    ;% Swingup_energy_P.HILInitialize_POPStart
                    section.data(29).logicalSrcIdx = 88;
                    section.data(29).dtTransOffset = 28;

                    ;% Swingup_energy_P.HILInitialize_POPEnter
                    section.data(30).logicalSrcIdx = 89;
                    section.data(30).dtTransOffset = 29;

                    ;% Swingup_energy_P.HILInitialize_POStart
                    section.data(31).logicalSrcIdx = 90;
                    section.data(31).dtTransOffset = 30;

                    ;% Swingup_energy_P.HILInitialize_POEnter
                    section.data(32).logicalSrcIdx = 91;
                    section.data(32).dtTransOffset = 31;

                    ;% Swingup_energy_P.HILInitialize_POReset
                    section.data(33).logicalSrcIdx = 92;
                    section.data(33).dtTransOffset = 32;

                    ;% Swingup_energy_P.HILInitialize_OOReset
                    ...
                    ;% Swingup_energy_P.HILReadEncoderTimebase_Active
                    section.data(37).logicalSrcIdx = 96;
                    section.data(37).dtTransOffset = 36;

                    ;% Swingup_energy_P.HILReadEncoder_Active
                    section.data(38).logicalSrcIdx = 97;
                    section.data(38).dtTransOffset = 37;

                    ;% Swingup_energy_P.HILWriteAnalog_Active
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_P.HILReadEncoderTimebase_Overflow
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(14)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_B.Gain
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% Swingup_energy_B.Gain1
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;
                    ...
                    ;% Swingup_energy_B.VectorConcatenate
                    ...
                    ;% Swingup_energy_B.Add
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 9;

                    ;% Swingup_energy_B.Saturation
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 10;

                    ;% Swingup_energy_B.Switch
                    ...
                    ;% Swingup_energy_B.Gain_n
                    section.data(11).logicalSrcIdx = 10;
                    section.data(11).dtTransOffset = 13;

                    ;% Swingup_energy_B.Gain_f
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_B.RelationalOperator2
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_DW.HILInitialize_FilterFrequency
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_DW.HILReadEncoder_PWORK
                    section.data(1).logicalSrcIdx = 5;
                    section.data(1).dtTransOffset = 0;

                    ;% Swingup_energy_DW.HILWriteAnalog_PWORK
                    section.data(2).logicalSrcIdx = 6;
                    section.data(2).dtTransOffset = 1;

                    ;% Swingup_energy_DW.MotorVoltageV_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 7;
                    section.data(3).dtTransOffset = 2;

                    ;% Swingup_energy_DW.PendAngledeg1_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 8;
                    section.data(4).dtTransOffset = 3;

                    ;% Swingup_energy_DW.ServoAngledeg_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 9;
                    section.data(5).dtTransOffset = 4;

                    ;% Swingup_energy_DW.ToWorkspace_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 10;
                    section.data(6).dtTransOffset = 5;

                    ;% Swingup_energy_DW.ToWorkspace1_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 11;
                    section.data(7).dtTransOffset = 6;

                    ;% Swingup_energy_DW.ToWorkspace2_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 12;
                    section.data(8).dtTransOffset = 7;

                    ;% Swingup_energy_DW.ToWorkspace3_PWORK.LoggedData
                    section.data(9).logicalSrcIdx = 13;
                    section.data(9).dtTransOffset = 8;

                    ;% Swingup_energy_DW.ToWorkspace4_PWORK.LoggedData
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_DW.HILInitialize_ClockModes
                    section.data(1).logicalSrcIdx = 15;
                    section.data(1).dtTransOffset = 0;

                    ;% Swingup_energy_DW.HILInitialize_DOStates
                    section.data(2).logicalSrcIdx = 16;
                    section.data(2).dtTransOffset = 1;

                    ;% Swingup_energy_DW.HILInitialize_QuadratureModes
                    section.data(3).logicalSrcIdx = 17;
                    section.data(3).dtTransOffset = 2;

                    ;% Swingup_energy_DW.HILInitialize_InitialEICounts
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Swingup_energy_DW.DiscreteTimeIntegrator_PrevRese
    ...
    targMap.checksum0 = 2726450178;
    targMap.checksum1 = 3773360446;
    targMap.checksum2 = 2399443072;
    targMap.checksum3 = 4151263181;
