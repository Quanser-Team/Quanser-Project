...
#ifndef RTW_HEADER_Test_PID_ok_h_
#define RTW_HEADER_Test_PID_ok_h_
#ifndef Test_PID_ok_COMMON_INCLUDES_
#define Test_PID_ok_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Test_PID_ok_COMMON_INCLUDES_ */
...
#define Test_PID_ok_rtModel            RT_MODEL_Test_PID_ok_T
...
typedef struct {
  ...
  boolean_T LogicalOperator1;          /* '<S53>/Logical Operator1' */
...
typedef struct {
  ...
  int8_T DiscreteTimeIntegrator_PrevRese;/* '<S53>/Discrete-Time Integrator' */
} DW_Test_PID_ok_T;
...
#define rtB                            Test_PID_ok_B
#define BlockIO                        B_Test_PID_ok_T
#define rtX                            Test_PID_ok_X
#define ContinuousStates               X_Test_PID_ok_T
#define rtXdot                         Test_PID_ok_XDot
#define StateDerivatives               XDot_Test_PID_ok_T
#define tXdis                          Test_PID_ok_XDis
#define StateDisabled                  XDis_Test_PID_ok_T
#define rtP                            Test_PID_ok_P
#define Parameters                     P_Test_PID_ok_T
#define rtDWork                        Test_PID_ok_DW
#define D_Work                         DW_Test_PID_ok_T

/* Parameters (default storage) */
struct P_Test_PID_ok_T_ {
  ...
  int8_T StopwithMessage_message_icon;
                                  ...
                                  * Referenced by: '<S54>/Show Message on Host'
                                  */
  ...
  real_T SmoothSignalGenerator_Frequency;/* Expression: i_frequency
                                          * Referenced by: '<Root>/Smooth Signal Generator'
                                          */
  real_T Gain_Gain;                    /* Expression: 90
...
extern P_Test_PID_ok_T Test_PID_ok_P;

/* Block signals (default storage) */
extern B_Test_PID_ok_T Test_PID_ok_B;

/* Continuous states (default storage) */
extern X_Test_PID_ok_T Test_PID_ok_X;

/* Block states (default storage) */
extern DW_Test_PID_ok_T Test_PID_ok_DW;

/* Model entry point functions */
extern void Test_PID_ok_initialize(void);
extern void Test_PID_ok_output(void);
extern void Test_PID_ok_update(void);
extern void Test_PID_ok_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Test_PID_ok_rtModel *Test_PID_ok(void);
...
extern RT_MODEL_Test_PID_ok_T *const Test_PID_ok_M;
 ...
 *
 * '<Root>' : 'Test_PID_ok'
 * '<S1>'   : 'Test_PID_ok/Degrees to Radians'
 * '<S2>'   : 'Test_PID_ok/PID Controller1'
 * '<S3>'   : 'Test_PID_ok/Radians to Degrees1'
 * '<S4>'   : 'Test_PID_ok/Stall Detection'
 * '<S5>'   : 'Test_PID_ok/PID Controller1/Anti-windup'
 * '<S6>'   : 'Test_PID_ok/PID Controller1/D Gain'
 * '<S7>'   : 'Test_PID_ok/PID Controller1/Filter'
 * '<S8>'   : 'Test_PID_ok/PID Controller1/Filter ICs'
 * '<S9>'   : 'Test_PID_ok/PID Controller1/I Gain'
 * '<S10>'  : 'Test_PID_ok/PID Controller1/Ideal P Gain'
 * '<S11>'  : 'Test_PID_ok/PID Controller1/Ideal P Gain Fdbk'
 * '<S12>'  : 'Test_PID_ok/PID Controller1/Integrator'
 * '<S13>'  : 'Test_PID_ok/PID Controller1/Integrator ICs'
 * '<S14>'  : 'Test_PID_ok/PID Controller1/N Copy'
 * '<S15>'  : 'Test_PID_ok/PID Controller1/N Gain'
 * '<S16>'  : 'Test_PID_ok/PID Controller1/P Copy'
 * '<S17>'  : 'Test_PID_ok/PID Controller1/Parallel P Gain'
 * '<S18>'  : 'Test_PID_ok/PID Controller1/Reset Signal'
 * '<S19>'  : 'Test_PID_ok/PID Controller1/Saturation'
 * '<S20>'  : 'Test_PID_ok/PID Controller1/Saturation Fdbk'
 * '<S21>'  : 'Test_PID_ok/PID Controller1/Sum'
 * '<S22>'  : 'Test_PID_ok/PID Controller1/Sum Fdbk'
 * '<S23>'  : 'Test_PID_ok/PID Controller1/Tracking Mode'
 * '<S24>'  : 'Test_PID_ok/PID Controller1/Tracking Mode Sum'
 * '<S25>'  : 'Test_PID_ok/PID Controller1/Tsamp - Integral'
 * '<S26>'  : 'Test_PID_ok/PID Controller1/Tsamp - Ngain'
 * '<S27>'  : 'Test_PID_ok/PID Controller1/postSat Signal'
 * '<S28>'  : 'Test_PID_ok/PID Controller1/preSat Signal'
 * '<S29>'  : 'Test_PID_ok/PID Controller1/Anti-windup/Passthrough'
 * '<S30>'  : 'Test_PID_ok/PID Controller1/D Gain/Internal Parameters'
 * '<S31>'  : 'Test_PID_ok/PID Controller1/Filter/Cont. Filter'
 * '<S32>'  : 'Test_PID_ok/PID Controller1/Filter ICs/Internal IC - Filter'
 * '<S33>'  : 'Test_PID_ok/PID Controller1/I Gain/Internal Parameters'
 * '<S34>'  : 'Test_PID_ok/PID Controller1/Ideal P Gain/Passthrough'
 * '<S35>'  : 'Test_PID_ok/PID Controller1/Ideal P Gain Fdbk/Disabled'
 * '<S36>'  : 'Test_PID_ok/PID Controller1/Integrator/Continuous'
 * '<S37>'  : 'Test_PID_ok/PID Controller1/Integrator ICs/Internal IC'
 * '<S38>'  : 'Test_PID_ok/PID Controller1/N Copy/Disabled'
 * '<S39>'  : 'Test_PID_ok/PID Controller1/N Gain/Internal Parameters'
 * '<S40>'  : 'Test_PID_ok/PID Controller1/P Copy/Disabled'
 * '<S41>'  : 'Test_PID_ok/PID Controller1/Parallel P Gain/Internal Parameters'
 * '<S42>'  : 'Test_PID_ok/PID Controller1/Reset Signal/Disabled'
 * '<S43>'  : 'Test_PID_ok/PID Controller1/Saturation/Passthrough'
 * '<S44>'  : 'Test_PID_ok/PID Controller1/Saturation Fdbk/Disabled'
 * '<S45>'  : 'Test_PID_ok/PID Controller1/Sum/Sum_PID'
 * '<S46>'  : 'Test_PID_ok/PID Controller1/Sum Fdbk/Disabled'
 * '<S47>'  : 'Test_PID_ok/PID Controller1/Tracking Mode/Disabled'
 * '<S48>'  : 'Test_PID_ok/PID Controller1/Tracking Mode Sum/Passthrough'
 * '<S49>'  : 'Test_PID_ok/PID Controller1/Tsamp - Integral/Passthrough'
 * '<S50>'  : 'Test_PID_ok/PID Controller1/Tsamp - Ngain/Passthrough'
 * '<S51>'  : 'Test_PID_ok/PID Controller1/postSat Signal/Forward_Path'
 * '<S52>'  : 'Test_PID_ok/PID Controller1/preSat Signal/Forward_Path'
 * '<S53>'  : 'Test_PID_ok/Stall Detection/Stall Monitor'
 * '<S54>'  : 'Test_PID_ok/Stall Detection/Stop with Message'
 * '<S55>'  : 'Test_PID_ok/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Test_PID_ok_h_ */
