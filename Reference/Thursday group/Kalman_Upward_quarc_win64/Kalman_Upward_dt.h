...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&Kalman_Upward_B.countstorad1), 0, 0, 31 },
  ...
  { (char_T *)(&Kalman_Upward_DW.HILReadEncoder_PWORK), 11, 0, 15 },

  { (char_T *)(&Kalman_Upward_DW.HILInitialize_ClockModes), 6, 0, 8 },

  { (char_T *)(&Kalman_Upward_DW.FromWorkspace_IWORK.PrevIndex), 10, 0, 2 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&Kalman_Upward_P.Lykyhatkk1_Y0), 0, 0, 100 },
