    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(48)  = dumData; %prealloc
                    ...
                    ;% Kalman_Upward_P.Amplitudedeg_Gain
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(20)  = dumData; %prealloc
                    ...
                    ;% Kalman_Upward_B.FromWorkspace1
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(15)  = dumData; %prealloc
                    ...
                    ;% Kalman_Upward_DW.FromWorkspace_PWORK.TimePtr
                    section.data(2).logicalSrcIdx = 7;
                    section.data(2).dtTransOffset = 1;

                    ;% Kalman_Upward_DW.FromWorkspace1_PWORK.TimePtr
                    ...
                    ;% Kalman_Upward_DW.Scope1_PWORK.LoggedData
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Kalman_Upward_DW.FromWorkspace_IWORK.PrevIndex
                    section.data(1).logicalSrcIdx = 27;
                    section.data(1).dtTransOffset = 0;

                    ;% Kalman_Upward_DW.FromWorkspace1_IWORK.PrevIndex
    ...
    targMap.checksum0 = 379314031;
    targMap.checksum1 = 2767468535;
    targMap.checksum2 = 4169181882;
    targMap.checksum3 = 3985389177;
