    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (qube_servo2_quick_start_grupp_P)
        ;%
            section.nData     = 5;
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILReadEncoder1_channels
                    section.data(1).logicalSrcIdx = 5;
                    section.data(1).dtTransOffset = 0;

                    ;% qube_servo2_quick_start_grupp_P.HILWriteAnalog_channels
                    section.data(2).logicalSrcIdx = 6;
                    section.data(2).dtTransOffset = 1;

                    ;% qube_servo2_quick_start_grupp_P.HILReadEncoder_channels
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grupp_P.StopwithMessage_message_icon
            ...
            section.data(29)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_OOTerminate
                    section.data(1).logicalSrcIdx = 9;
                    section.data(1).dtTransOffset = 0;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_OOExit
                    section.data(2).logicalSrcIdx = 10;
                    section.data(2).dtTransOffset = 1;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_OOStart
                    ...
                    ;% qube_servo2_quick_start_grupp_P.SmoothSignalGenerator_InitialPh
                    ...
                    ;% qube_servo2_quick_start_grupp_P.Amplitudedeg_Gain
                    section.data(18).logicalSrcIdx = 26;
                    section.data(18).dtTransOffset = 23;

                    ;% qube_servo2_quick_start_grupp_P.Gain1_Gain
                    ...
                    ;% qube_servo2_quick_start_grupp_P.Gain_Gain
                    ...
                    ;% qube_servo2_quick_start_grupp_P.countstorad1_Gain
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_CKChannels
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_AIChannels
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_EIChannels
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_Active
                    section.data(2).logicalSrcIdx = 48;
                    section.data(2).dtTransOffset = 1;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_AOTerminate
                    section.data(3).logicalSrcIdx = 49;
                    section.data(3).dtTransOffset = 2;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_AOExit
                    section.data(4).logicalSrcIdx = 50;
                    section.data(4).dtTransOffset = 3;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_DOTerminate
                    section.data(5).logicalSrcIdx = 51;
                    section.data(5).dtTransOffset = 4;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_DOExit
                    section.data(6).logicalSrcIdx = 52;
                    section.data(6).dtTransOffset = 5;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_POTerminate
                    section.data(7).logicalSrcIdx = 53;
                    section.data(7).dtTransOffset = 6;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_POExit
                    section.data(8).logicalSrcIdx = 54;
                    section.data(8).dtTransOffset = 7;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_CKPStart
                    section.data(9).logicalSrcIdx = 55;
                    section.data(9).dtTransOffset = 8;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_CKPEnter
                    section.data(10).logicalSrcIdx = 56;
                    section.data(10).dtTransOffset = 9;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_CKStart
                    section.data(11).logicalSrcIdx = 57;
                    section.data(11).dtTransOffset = 10;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_CKEnter
                    section.data(12).logicalSrcIdx = 58;
                    section.data(12).dtTransOffset = 11;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_AIPStart
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_AOPStart
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_AOStart
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_AOReset
                    section.data(19).logicalSrcIdx = 65;
                    section.data(19).dtTransOffset = 18;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_DOPStart
                    section.data(20).logicalSrcIdx = 66;
                    section.data(20).dtTransOffset = 19;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_DOPEnter
                    section.data(21).logicalSrcIdx = 67;
                    section.data(21).dtTransOffset = 20;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_DOStart
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_DOReset
                    section.data(24).logicalSrcIdx = 70;
                    section.data(24).dtTransOffset = 23;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_EIPStart
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_EIStart
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_POPStart
                    section.data(29).logicalSrcIdx = 75;
                    section.data(29).dtTransOffset = 28;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_POPEnter
                    section.data(30).logicalSrcIdx = 76;
                    section.data(30).dtTransOffset = 29;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_POStart
                    section.data(31).logicalSrcIdx = 77;
                    section.data(31).dtTransOffset = 30;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_POEnter
                    section.data(32).logicalSrcIdx = 78;
                    section.data(32).dtTransOffset = 31;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_POReset
                    section.data(33).logicalSrcIdx = 79;
                    section.data(33).dtTransOffset = 32;

                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_OOReset
                    ...
                    ;% qube_servo2_quick_start_grupp_P.HILInitialize_DOInitial
                    section.data(36).logicalSrcIdx = 82;
                    section.data(36).dtTransOffset = 35;

                    ;% qube_servo2_quick_start_grupp_P.HILReadEncoder1_Active
                    section.data(37).logicalSrcIdx = 83;
                    section.data(37).dtTransOffset = 36;

                    ;% qube_servo2_quick_start_grupp_P.HILWriteAnalog_Active
                    section.data(38).logicalSrcIdx = 84;
                    section.data(38).dtTransOffset = 37;

                    ;% qube_servo2_quick_start_grupp_P.HILReadEncoder_Active
    ...
    ;%**************************
        ...
        ;%
        ;% Auto data (qube_servo2_quick_start_grupp_B)
        ;%
            section.nData     = 7;
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grupp_B.Gain
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;
    ...
    ;%*******************
        ...
        ;%
        ;% Auto data (qube_servo2_quick_start_grup_DW)
        ;%
            section.nData     = 2;
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grup_DW.HILInitialize_FilterFrequency
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grup_DW.HILReadEncoder1_PWORK
                    section.data(1).logicalSrcIdx = 4;
                    section.data(1).dtTransOffset = 0;

                    ;% qube_servo2_quick_start_grup_DW.HILWriteAnalog_PWORK
                    section.data(2).logicalSrcIdx = 5;
                    section.data(2).dtTransOffset = 1;

                    ;% qube_servo2_quick_start_grup_DW.MotorVoltageV_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 6;
                    section.data(3).dtTransOffset = 2;

                    ;% qube_servo2_quick_start_grup_DW.ServoAngledeg_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 7;
                    section.data(4).dtTransOffset = 3;

                    ;% qube_servo2_quick_start_grup_DW.HILReadEncoder_PWORK
                    section.data(5).logicalSrcIdx = 8;
                    section.data(5).dtTransOffset = 4;

                    ;% qube_servo2_quick_start_grup_DW.PendAngledeg1_PWORK.LoggedData
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grup_DW.HILInitialize_ClockModes
                    section.data(1).logicalSrcIdx = 10;
                    section.data(1).dtTransOffset = 0;

                    ;% qube_servo2_quick_start_grup_DW.HILInitialize_DOStates
                    section.data(2).logicalSrcIdx = 11;
                    section.data(2).dtTransOffset = 1;

                    ;% qube_servo2_quick_start_grup_DW.HILInitialize_QuadratureModes
                    section.data(3).logicalSrcIdx = 12;
                    section.data(3).dtTransOffset = 2;

                    ;% qube_servo2_quick_start_grup_DW.HILInitialize_InitialEICounts
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% qube_servo2_quick_start_grup_DW.DiscreteTimeIntegrator_PrevRese
    ...
    targMap.checksum0 = 1956525661;
    targMap.checksum1 = 3303716912;
    targMap.checksum2 = 3689123495;
    targMap.checksum3 = 2518324374;
