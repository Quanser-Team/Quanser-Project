 ...
 * '<S5>'   : 'qube_servo2_quick_start_groupA/Stall Detection'
 * '<S6>'   : 'qube_servo2_quick_start_groupA/Stall Detection/Stall Monitor'
 * '<S7>'   : 'qube_servo2_quick_start_groupA/Stall Detection/Stop with Message'
 * '<S8>'   : 'qube_servo2_quick_start_groupA/Stall Detection/Stop with Message/Compare'
 */
