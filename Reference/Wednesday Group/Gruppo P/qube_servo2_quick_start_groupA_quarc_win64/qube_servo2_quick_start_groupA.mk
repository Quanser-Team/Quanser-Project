###########################################################################
## Makefile generated for component 'qube_servo2_quick_start_groupA'. 
## 
## Makefile     : qube_servo2_quick_start_groupA.mk
## Generated on : Thu Sep 28 16:41:17 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\qube_servo2_quick_start_groupA.rt-win64
...
PRODUCT_NAME              = qube_servo2_quick_start_groupA
MAKEFILE                  = qube_servo2_quick_start_groupA.mk
...
COMPILER_COMMAND_FILE     = qube_servo2_quick_start_groupA_comp.rsp
CMD_FILE                  = qube_servo2_quick_start_groupA.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\qube_servo2_quick_start_groupA.rt-win64
...
DEFINES_STANDARD = -DMODEL=qube_servo2_quick_start_groupA -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA.c $(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA_data.c $(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA_main.c $(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rtGetInf.c $(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rtGetNaN.c $(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = qube_servo2_quick_start_groupA.obj qube_servo2_quick_start_groupA_data.obj qube_servo2_quick_start_groupA_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
qube_servo2_quick_start_groupA.obj : "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA.c"


qube_servo2_quick_start_groupA_data.obj : "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA_data.c"


qube_servo2_quick_start_groupA_main.obj : "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\qube_servo2_quick_start_groupA_main.c"


rtGetInf.obj : "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_groupA_quarc_win64\rt_nonfinite.c"
