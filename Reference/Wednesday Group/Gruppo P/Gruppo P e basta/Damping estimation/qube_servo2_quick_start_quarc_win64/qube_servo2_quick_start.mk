###########################################################################
## Makefile generated for component 'qube_servo2_quick_start'. 
## 
## Makefile     : qube_servo2_quick_start.mk
## Generated on : Wed Oct 04 17:35:59 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\qube_servo2_quick_start.rt-win64
...
PRODUCT_NAME              = qube_servo2_quick_start
MAKEFILE                  = qube_servo2_quick_start.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Utente\Desktop\WEDNES~1\GRUPPO~1\GRUPPO~1\DAMPIN~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = qube_servo2_quick_start_comp.rsp
CMD_FILE                  = qube_servo2_quick_start.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\qube_servo2_quick_start.rt-win64
...
DEFINES_STANDARD = -DMODEL=qube_servo2_quick_start -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start.c $(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start_data.c $(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start_main.c $(START_DIR)\qube_servo2_quick_start_quarc_win64\rtGetInf.c $(START_DIR)\qube_servo2_quick_start_quarc_win64\rtGetNaN.c $(START_DIR)\qube_servo2_quick_start_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = qube_servo2_quick_start.obj qube_servo2_quick_start_data.obj qube_servo2_quick_start_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\qube_servo2_quick_start_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\qube_servo2_quick_start_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
qube_servo2_quick_start.obj : "$(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start.c"


qube_servo2_quick_start_data.obj : "$(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start_data.c"


qube_servo2_quick_start_main.obj : "$(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_quarc_win64\qube_servo2_quick_start_main.c"


rtGetInf.obj : "$(START_DIR)\qube_servo2_quick_start_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\qube_servo2_quick_start_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\qube_servo2_quick_start_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube_servo2_quick_start_quarc_win64\rt_nonfinite.c"
