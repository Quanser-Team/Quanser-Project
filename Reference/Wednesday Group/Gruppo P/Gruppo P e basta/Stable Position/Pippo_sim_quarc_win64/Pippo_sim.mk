###########################################################################
## Makefile generated for component 'Pippo_sim'. 
## 
## Makefile     : Pippo_sim.mk
## Generated on : Wed Oct 18 15:35:06 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Pippo_sim.rt-win64
...
PRODUCT_NAME              = Pippo_sim
MAKEFILE                  = Pippo_sim.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Utente\Desktop\WEDNES~1\GRUPPO~1\GRUPPO~1\STABLE~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Pippo_sim_comp.rsp
CMD_FILE                  = Pippo_sim.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Pippo_sim.rt-win64
...
DEFINES_STANDARD = -DMODEL=Pippo_sim -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim.c $(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim_data.c $(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim_main.c $(START_DIR)\Pippo_sim_quarc_win64\rtGetInf.c $(START_DIR)\Pippo_sim_quarc_win64\rtGetNaN.c $(START_DIR)\Pippo_sim_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Pippo_sim.obj Pippo_sim_data.obj Pippo_sim_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Pippo_sim_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Pippo_sim_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Pippo_sim.obj : "$(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim.c"


Pippo_sim_data.obj : "$(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim_data.c"


Pippo_sim_main.obj : "$(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pippo_sim_quarc_win64\Pippo_sim_main.c"


rtGetInf.obj : "$(START_DIR)\Pippo_sim_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pippo_sim_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Pippo_sim_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pippo_sim_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Pippo_sim_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pippo_sim_quarc_win64\rt_nonfinite.c"
