###########################################################################
## Makefile generated for component 'Kalman_Filterr'. 
## 
## Makefile     : Kalman_Filterr.mk
## Generated on : Wed Nov 15 16:00:17 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Kalman_Filterr.rt-win64
...
PRODUCT_NAME              = Kalman_Filterr
MAKEFILE                  = Kalman_Filterr.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Utente\Desktop\WEDNES~1\GRUPPO~1\GRUPPO~1\10-KAL~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Kalman_Filterr_comp.rsp
CMD_FILE                  = Kalman_Filterr.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Kalman_Filterr.rt-win64
...
DEFINES_STANDARD = -DMODEL=Kalman_Filterr -DNUMST=3 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr.c $(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr_data.c $(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr_main.c $(START_DIR)\Kalman_Filterr_quarc_win64\rtGetInf.c $(START_DIR)\Kalman_Filterr_quarc_win64\rtGetNaN.c $(START_DIR)\Kalman_Filterr_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Kalman_Filterr.obj Kalman_Filterr_data.obj Kalman_Filterr_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Kalman_Filterr_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Kalman_Filterr_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Kalman_Filterr.obj : "$(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr.c"


Kalman_Filterr_data.obj : "$(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr_data.c"


Kalman_Filterr_main.obj : "$(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Filterr_quarc_win64\Kalman_Filterr_main.c"


rtGetInf.obj : "$(START_DIR)\Kalman_Filterr_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Filterr_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Kalman_Filterr_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Filterr_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Kalman_Filterr_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Kalman_Filterr_quarc_win64\rt_nonfinite.c"
