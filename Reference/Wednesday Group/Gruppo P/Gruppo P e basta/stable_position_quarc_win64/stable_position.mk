###########################################################################
## Makefile generated for component 'stable_position'. 
## 
## Makefile     : stable_position.mk
## Generated on : Wed Oct 25 19:01:49 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\stable_position.rt-win64
...
PRODUCT_NAME              = stable_position
MAKEFILE                  = stable_position.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Utente\Desktop\WEDNES~1\GRUPPO~1\GRUPPO~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = stable_position_comp.rsp
CMD_FILE                  = stable_position.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\stable_position.rt-win64
...
DEFINES_STANDARD = -DMODEL=stable_position -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\stable_position_quarc_win64\rtGetInf.c $(START_DIR)\stable_position_quarc_win64\rtGetNaN.c $(START_DIR)\stable_position_quarc_win64\rt_nonfinite.c $(START_DIR)\stable_position_quarc_win64\stable_position.c $(START_DIR)\stable_position_quarc_win64\stable_position_data.c $(START_DIR)\stable_position_quarc_win64\stable_position_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj stable_position.obj stable_position_data.obj stable_position_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\stable_position_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\stable_position_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\stable_position_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\stable_position_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\stable_position_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\stable_position_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\stable_position_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\stable_position_quarc_win64\rt_nonfinite.c"


stable_position.obj : "$(START_DIR)\stable_position_quarc_win64\stable_position.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\stable_position_quarc_win64\stable_position.c"


stable_position_data.obj : "$(START_DIR)\stable_position_quarc_win64\stable_position_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\stable_position_quarc_win64\stable_position_data.c"


stable_position_main.obj : "$(START_DIR)\stable_position_quarc_win64\stable_position_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\stable_position_quarc_win64\stable_position_main.c"
