...
#ifndef RTW_HEADER_stable_position_h_
#define RTW_HEADER_stable_position_h_
#ifndef stable_position_COMMON_INCLUDES_
#define stable_position_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* stable_position_COMMON_INCLUDES_ */

#include "stable_position_types.h"
...
#define stable_position_rtModel        RT_MODEL_stable_position_T
...
#define rtB                            stable_position_B
#define BlockIO                        B_stable_position_T
#define rtX                            stable_position_X
#define ContinuousStates               X_stable_position_T
#define rtXdot                         stable_position_XDot
#define StateDerivatives               XDot_stable_position_T
#define tXdis                          stable_position_XDis
#define StateDisabled                  XDis_stable_position_T
#define rtP                            stable_position_P
#define Parameters                     P_stable_position_T
#define rtDWork                        stable_position_DW
#define D_Work                         DW_stable_position_T

/* Parameters (default storage) */
struct P_stable_position_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T kp_theta_Gain;                /* Expression: 4.8
  ...
  real_T alpha_dot_D;                  /* Computed Parameter: alpha_dot_D
                                        * Referenced by: '<Root>/alpha_dot'
                                        */
  real_T kd_alpha_Gain;                /* Expression: 0.21
...
struct tag_RTM_stable_position_T {
  const char_T *path;
...
extern P_stable_position_T stable_position_P;

/* Block signals (default storage) */
extern B_stable_position_T stable_position_B;

/* Continuous states (default storage) */
extern X_stable_position_T stable_position_X;

/* Block states (default storage) */
extern DW_stable_position_T stable_position_DW;

/* Model entry point functions */
extern void stable_position_initialize(void);
extern void stable_position_output(void);
extern void stable_position_update(void);
extern void stable_position_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern stable_position_rtModel *stable_position(void);
...
extern RT_MODEL_stable_position_T *const stable_position_M;
 ...
 *
 * '<Root>' : 'stable_position'
 * '<S1>'   : 'stable_position/Degrees to Radians'
 * '<S2>'   : 'stable_position/Enable Balance Control'
 * '<S3>'   : 'stable_position/Radians to Degrees'
 * '<S4>'   : 'stable_position/Radians to Degrees1'
 * '<S5>'   : 'stable_position/Radians to Degrees2'
 * '<S6>'   : 'stable_position/Rotary Pendulum Interface'
 * '<S7>'   : 'stable_position/Rotary Pendulum Interface/Counts to Angles'
 */
#endif                                 /* RTW_HEADER_stable_position_h_ */
