 ...
 * C source code generated on : Wed Oct 25 15:20:10 2023
 *
...
#ifndef RTW_HEADER_q_qube2_balance_h_
#define RTW_HEADER_q_qube2_balance_h_
#ifndef q_qube2_balance_COMMON_INCLUDES_
#define q_qube2_balance_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* q_qube2_balance_COMMON_INCLUDES_ */

#include "q_qube2_balance_types.h"
...
#define q_qube2_balance_rtModel        RT_MODEL_q_qube2_balance_T
...
typedef struct {
  ...
  real_T kp_theta;                     /* '<Root>/kp_theta' */
  real_T theta;                        /* '<Root>/-theta' */
  real_T alpha;                        /* '<Root>/-alpha' */
  real_T kp_alpha;                     /* '<Root>/kp_alpha' */
...
} DW_q_qube2_balance_T;

/* Continuous states (default storage) */
typedef struct {
  real_T theta_dot_CSTATE;             /* '<Root>/theta_dot' */
...
typedef struct {
  real_T theta_dot_CSTATE;             /* '<Root>/theta_dot' */
  real_T alpha_dot_CSTATE;             /* '<Root>/alpha_dot' */
} XDot_q_qube2_balance_T;

/* State disabled  */
typedef struct {
  boolean_T theta_dot_CSTATE;          /* '<Root>/theta_dot' */
  boolean_T alpha_dot_CSTATE;          /* '<Root>/alpha_dot' */
} XDis_q_qube2_balance_T;
...
#define rtB                            q_qube2_balance_B
#define BlockIO                        B_q_qube2_balance_T
#define rtX                            q_qube2_balance_X
#define ContinuousStates               X_q_qube2_balance_T
#define rtXdot                         q_qube2_balance_XDot
#define StateDerivatives               XDot_q_qube2_balance_T
#define tXdis                          q_qube2_balance_XDis
#define StateDisabled                  XDis_q_qube2_balance_T
#define rtP                            q_qube2_balance_P
#define Parameters                     P_q_qube2_balance_T
#define rtDWork                        q_qube2_balance_DW
#define D_Work                         DW_q_qube2_balance_T

/* Parameters (default storage) */
struct P_q_qube2_balance_T_ {
  ...
  uint32_T HILWriteAnalog_channels;   /* Mask Parameter: HILWriteAnalog_channels
                                       ...
                                       */
  real_T kd_alpha_Gain;                /* Expression: 2.5
                                        * Referenced by: '<Root>/kd_alpha'
                                        */
  real_T kd_theta_Gain;                /* Expression: -2
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T kp_theta_Gain;                /* Expression: -2
                                        * Referenced by: '<Root>/kp_theta'
                                        */
  real_T theta_Gain;                   /* Expression: -1
  ...
  real_T theta_dot_D;                  /* Computed Parameter: theta_dot_D
                                        * Referenced by: '<Root>/theta_dot'
                                        */
  real_T alpha_Gain;                   /* Expression: -1
                                        * Referenced by: '<Root>/-alpha'
                                        */
  real_T kp_alpha_Gain;                /* Expression: 30
...
struct tag_RTM_q_qube2_balance_T {
  const char_T *path;
...
extern P_q_qube2_balance_T q_qube2_balance_P;

/* Block signals (default storage) */
extern B_q_qube2_balance_T q_qube2_balance_B;

/* Continuous states (default storage) */
extern X_q_qube2_balance_T q_qube2_balance_X;

/* Block states (default storage) */
extern DW_q_qube2_balance_T q_qube2_balance_DW;

/* Model entry point functions */
extern void q_qube2_balance_initialize(void);
extern void q_qube2_balance_output(void);
extern void q_qube2_balance_update(void);
extern void q_qube2_balance_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_qube2_balance_rtModel *q_qube2_balance(void);
...
extern RT_MODEL_q_qube2_balance_T *const q_qube2_balance_M;
 ...
 *
 * '<Root>' : 'q_qube2_balance'
 * '<S1>'   : 'q_qube2_balance/Degrees to Radians'
 * '<S2>'   : 'q_qube2_balance/Enable Balance Control'
 * '<S3>'   : 'q_qube2_balance/Radians to Degrees'
 * '<S4>'   : 'q_qube2_balance/Radians to Degrees1'
 * '<S5>'   : 'q_qube2_balance/Rotary Pendulum Interface'
 * '<S6>'   : 'q_qube2_balance/Rotary Pendulum Interface/Counts to Angles'
 */
#endif                                 /* RTW_HEADER_q_qube2_balance_h_ */
