###########################################################################
## Makefile generated for component 'q_qube2_balance'. 
## 
## Makefile     : q_qube2_balance.mk
## Generated on : Wed Oct 25 15:20:19 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_balance.rt-win64
...
COMPILER_COMMAND_FILE     = q_qube2_balance_comp.rsp
CMD_FILE                  = q_qube2_balance.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_balance.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_qube2_balance -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance.c $(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance_data.c $(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance_main.c $(START_DIR)\q_qube2_balance_quarc_win64\rtGetInf.c $(START_DIR)\q_qube2_balance_quarc_win64\rtGetNaN.c $(START_DIR)\q_qube2_balance_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_qube2_balance.obj q_qube2_balance_data.obj q_qube2_balance_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_qube2_balance_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_qube2_balance_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_qube2_balance.obj : "$(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance.c"


q_qube2_balance_data.obj : "$(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance_data.c"


q_qube2_balance_main.obj : "$(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_balance_quarc_win64\q_qube2_balance_main.c"


rtGetInf.obj : "$(START_DIR)\q_qube2_balance_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_balance_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_qube2_balance_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_balance_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_qube2_balance_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_balance_quarc_win64\rt_nonfinite.c"
