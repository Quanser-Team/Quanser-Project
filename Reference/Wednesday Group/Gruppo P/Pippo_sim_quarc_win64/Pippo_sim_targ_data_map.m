    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.StallMonitor_control_threshold
                    ...
                    ;% Pippo_sim_P.DerivativeGain_gain
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% Pippo_sim_P.StallMonitor_motion_threshold
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.HILWriteAnalog_channels
                    section.data(1).logicalSrcIdx = 5;
                    section.data(1).dtTransOffset = 0;

                    ;% Pippo_sim_P.HILReadEncoder_channels
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.StopwithMessage_message_icon
            ...
            section.data(30)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.PulseGenerator_Amp
                    section.data(15).logicalSrcIdx = 22;
                    section.data(15).dtTransOffset = 20;

                    ;% Pippo_sim_P.PulseGenerator_Period
                    section.data(16).logicalSrcIdx = 23;
                    section.data(16).dtTransOffset = 21;

                    ;% Pippo_sim_P.PulseGenerator_Duty
                    section.data(17).logicalSrcIdx = 24;
                    section.data(17).dtTransOffset = 22;

                    ;% Pippo_sim_P.PulseGenerator_PhaseDelay
                    section.data(18).logicalSrcIdx = 25;
                    section.data(18).dtTransOffset = 23;

                    ;% Pippo_sim_P.Amplitudedeg_Gain
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.HILReadEncoderTimebase_Clock
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.HILReadEncoderTimebase_Channels
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.HILReadEncoderTimebase_Active
                    section.data(37).logicalSrcIdx = 86;
                    section.data(37).dtTransOffset = 36;

                    ;% Pippo_sim_P.HILWriteAnalog_Active
                    section.data(38).logicalSrcIdx = 87;
                    section.data(38).dtTransOffset = 37;

                    ;% Pippo_sim_P.HILReadEncoder_Active
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_P.HILReadEncoderTimebase_Overflow
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_DW.HILWriteAnalog_PWORK
                    section.data(1).logicalSrcIdx = 4;
                    section.data(1).dtTransOffset = 0;

                    ;% Pippo_sim_DW.MotorVoltageV_PWORK.LoggedData
                    section.data(2).logicalSrcIdx = 5;
                    section.data(2).dtTransOffset = 1;

                    ;% Pippo_sim_DW.ServoAngledeg_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 6;
                    section.data(3).dtTransOffset = 2;

                    ;% Pippo_sim_DW.HILReadEncoder_PWORK
                    section.data(4).logicalSrcIdx = 7;
                    section.data(4).dtTransOffset = 3;

                    ;% Pippo_sim_DW.PendAngledeg1_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 8;
                    section.data(5).dtTransOffset = 4;

                    ;% Pippo_sim_DW.ToWorkspace_PWORK.LoggedData
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% Pippo_sim_DW.DiscreteTimeIntegrator_PrevRese
    ...
    targMap.checksum0 = 1938217865;
    targMap.checksum1 = 16533667;
    targMap.checksum2 = 3880140428;
    targMap.checksum3 = 1236464264;
