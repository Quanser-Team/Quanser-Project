...
void qube_servo2_quick_start_output(void)
{
  ...
  if (rtmIsMajorTimeStep(qube_servo2_quick_start_M)) {
    ...
    /* S-Function Block: qube_servo2_quick_start/Smooth Signal Generator (smooth_signal_generator_block) */
    {
      real_T w = TWO_PI *
        qube_servo2_quick_start_P.SmoothSignalGenerator_Frequency;
      boolean_T params_changed =
        (qube_servo2_quick_start_P.SmoothSignalGenerator_Amplitude !=
         qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Amp || w !=
         qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.W);
      real_T T = TWO_PI /
        qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.W;
      if (qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T < 0.5 * T) {
        rtb_DiscreteTimeIntegrator =
          qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Amp;
      } else {
        rtb_DiscreteTimeIntegrator =
          -qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Amp;
      }
      ...
      if (params_changed) {
         ...
         */
        if (qube_servo2_quick_start_P.SmoothSignalGenerator_Amplitude == 0 ||
            rtb_DiscreteTimeIntegrator == 0 ||
            qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Y == 0 ||
            (rtb_DiscreteTimeIntegrator < 0) !=
            (qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Y < 0)) {
          qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Amp =
            qube_servo2_quick_start_P.SmoothSignalGenerator_Amplitude;
          qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.W = w;
          T = TWO_PI / w;
          if (rtb_DiscreteTimeIntegrator >= 0) {
            qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T = 0;
            rtb_DiscreteTimeIntegrator =
              qube_servo2_quick_start_P.SmoothSignalGenerator_Amplitude;
          } else {
            qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T = T / 2;
            rtb_DiscreteTimeIntegrator =
              -qube_servo2_quick_start_P.SmoothSignalGenerator_Amplitude;
          }
        }
      ...
      qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T += 0.002;
      if (qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T >= T) {
        qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T = 0;
      }

      qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Y =
        rtb_DiscreteTimeIntegrator;
    }
  ...
  if (rtmIsMajorTimeStep(qube_servo2_quick_start_M)) {
    ...
    /* Abs: '<S6>/Abs' */
    rtb_DiscreteTimeIntegrator = fabs(qube_servo2_quick_start_B.Sum1);
    ...
    /* Abs: '<S6>/Abs1' */
    rtb_DiscreteTimeIntegrator = fabs(qube_servo2_quick_start_B.ServoVelocity);
    ...
    qube_servo2_quick_start_B.LogicalOperator1 = !rtb_RelationalOperator1;
     ...
     */
    qube_servo2_quick_start_B.RelationalOperator2 = (rtb_DiscreteTimeIntegrator >=
    ...
    qube_servo2_quick_start_B.DataTypeConversion = rtb_RelationalOperator1;
  }
}
...
void qube_servo2_quick_start_initialize(void)
{
  ...
  /* S-Function Block: qube_servo2_quick_start/Smooth Signal Generator (smooth_signal_generator_block) */
  {
    real_T T = 1.0 / qube_servo2_quick_start_P.SmoothSignalGenerator_Frequency;
    qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Amp =
      qube_servo2_quick_start_P.SmoothSignalGenerator_Amplitude;
    qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.W = TWO_PI *
      qube_servo2_quick_start_P.SmoothSignalGenerator_Frequency;
    qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T = fmod
      (qube_servo2_quick_start_P.SmoothSignalGenerator_InitialPh, TWO_PI) * T /
      TWO_PI;
    if (qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T < 0) {
      qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T += T;
    }
...
RT_MODEL_qube_servo2_quick_st_T *qube_servo2_quick_start(void)
{
  ...
  /* External mode info */
  qube_servo2_quick_start_M->Sizes.checksums[0] = (4223036827U);
  qube_servo2_quick_start_M->Sizes.checksums[1] = (3092360901U);
  qube_servo2_quick_start_M->Sizes.checksums[2] = (2445551542U);
  qube_servo2_quick_start_M->Sizes.checksums[3] = (1899924881U);
  ...
  qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Amp = 0.0;
  qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.W = 0.0;
  qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.T = 0.0;
  qube_servo2_quick_start_DW.SmoothSignalGenerator_RWORK.Y = 0.0;
  ...
  qube_servo2_quick_start_M->Sizes.numBlockPrms = (94);/* Sum of parameter "widths" */
