...
#ifndef RTW_HEADER_Prova_sistema_h_
#define RTW_HEADER_Prova_sistema_h_
#ifndef Prova_sistema_COMMON_INCLUDES_
#define Prova_sistema_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Prova_sistema_COMMON_INCLUDES_ */

#include "Prova_sistema_types.h"
...
#define Prova_sistema_rtModel          RT_MODEL_Prova_sistema_T
...
#define rtB                            Prova_sistema_B
#define BlockIO                        B_Prova_sistema_T
#define rtX                            Prova_sistema_X
#define ContinuousStates               X_Prova_sistema_T
#define rtXdot                         Prova_sistema_XDot
#define StateDerivatives               XDot_Prova_sistema_T
#define tXdis                          Prova_sistema_XDis
#define StateDisabled                  XDis_Prova_sistema_T
#define rtP                            Prova_sistema_P
#define Parameters                     P_Prova_sistema_T
#define rtDWork                        Prova_sistema_DW
#define D_Work                         DW_Prova_sistema_T

/* Parameters (default storage) */
struct P_Prova_sistema_T_ {
  ...
  real_T SmoothSignalGenerator_Frequency;/* Expression: i_frequency
                                          * Referenced by: '<Root>/Smooth Signal Generator'
                                          */
  real_T Amplitudedeg_Gain;            /* Expression: 45
...
struct tag_RTM_Prova_sistema_T {
  const char_T *path;
...
extern P_Prova_sistema_T Prova_sistema_P;

/* Block signals (default storage) */
extern B_Prova_sistema_T Prova_sistema_B;

/* Continuous states (default storage) */
extern X_Prova_sistema_T Prova_sistema_X;

/* Block states (default storage) */
extern DW_Prova_sistema_T Prova_sistema_DW;

/* Model entry point functions */
extern void Prova_sistema_initialize(void);
extern void Prova_sistema_output(void);
extern void Prova_sistema_update(void);
extern void Prova_sistema_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Prova_sistema_rtModel *Prova_sistema(void);
...
extern RT_MODEL_Prova_sistema_T *const Prova_sistema_M;
 ...
 *
 * '<Root>' : 'Prova_sistema'
 * '<S1>'   : 'Prova_sistema/Degrees to Radians'
 * '<S2>'   : 'Prova_sistema/Radians to Degrees'
 * '<S3>'   : 'Prova_sistema/Radians to Degrees1'
 * '<S4>'   : 'Prova_sistema/Stall Detection'
 * '<S5>'   : 'Prova_sistema/Stall Detection/Stall Monitor'
 * '<S6>'   : 'Prova_sistema/Stall Detection/Stop with Message'
 * '<S7>'   : 'Prova_sistema/Stall Detection/Stop with Message/Compare'
 */
#endif                                 /* RTW_HEADER_Prova_sistema_h_ */
