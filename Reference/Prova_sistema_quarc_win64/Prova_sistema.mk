###########################################################################
## Makefile generated for component 'Prova_sistema'. 
## 
## Makefile     : Prova_sistema.mk
## Generated on : Wed Nov 22 17:54:10 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Prova_sistema.rt-win64
...
COMPILER_COMMAND_FILE     = Prova_sistema_comp.rsp
CMD_FILE                  = Prova_sistema.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Prova_sistema.rt-win64
...
DEFINES_STANDARD = -DMODEL=Prova_sistema -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema.c $(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema_data.c $(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema_main.c $(START_DIR)\Prova_sistema_quarc_win64\rtGetInf.c $(START_DIR)\Prova_sistema_quarc_win64\rtGetNaN.c $(START_DIR)\Prova_sistema_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Prova_sistema.obj Prova_sistema_data.obj Prova_sistema_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Prova_sistema_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Prova_sistema_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Prova_sistema.obj : "$(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema.c"


Prova_sistema_data.obj : "$(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema_data.c"


Prova_sistema_main.obj : "$(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Prova_sistema_quarc_win64\Prova_sistema_main.c"


rtGetInf.obj : "$(START_DIR)\Prova_sistema_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Prova_sistema_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Prova_sistema_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Prova_sistema_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Prova_sistema_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Prova_sistema_quarc_win64\rt_nonfinite.c"
