...
#ifndef RTW_HEADER_qube_servo2_quick_start_h_
#define RTW_HEADER_qube_servo2_quick_start_h_
#ifndef qube_servo2_quick_start_COMMON_INCLUDES_
#define qube_servo2_quick_start_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                            /* qube_servo2_quick_start_COMMON_INCLUDES_ */
...
#define qube_servo2_quick_start_rtModel RT_MODEL_qube_servo2_quick_st_T
...
} DW_qube_servo2_quick_start_T;

/* Continuous states (default storage) */
typedef struct {
  real_T ServoVelocity_CSTATE;         /* '<Root>/Servo Velocity' */
} X_qube_servo2_quick_start_T;

/* State derivatives (default storage) */
typedef struct {
  real_T ServoVelocity_CSTATE;         /* '<Root>/Servo Velocity' */
} XDot_qube_servo2_quick_start_T;

/* State disabled  */
typedef struct {
  boolean_T ServoVelocity_CSTATE;      /* '<Root>/Servo Velocity' */
} XDis_qube_servo2_quick_start_T;
...
#define rtB                            qube_servo2_quick_start_B
#define BlockIO                        B_qube_servo2_quick_start_T
#define rtX                            qube_servo2_quick_start_X
#define ContinuousStates               X_qube_servo2_quick_start_T
#define rtXdot                         qube_servo2_quick_start_XDot
#define StateDerivatives               XDot_qube_servo2_quick_start_T
#define tXdis                          qube_servo2_quick_start_XDis
#define StateDisabled                  XDis_qube_servo2_quick_start_T
#define rtP                            qube_servo2_quick_start_P
#define Parameters                     P_qube_servo2_quick_start_T
#define rtDWork                        qube_servo2_quick_start_DW
#define D_Work                         DW_qube_servo2_quick_start_T

/* Parameters (default storage) */
struct P_qube_servo2_quick_start_T_ {
  ...
  real_T HILInitialize_OOWatchdog[3];  /* Expression: watchdog_other_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T PulseGenerator_Amp;           /* Expression: 90
...
extern P_qube_servo2_quick_start_T qube_servo2_quick_start_P;

/* Block signals (default storage) */
extern B_qube_servo2_quick_start_T qube_servo2_quick_start_B;

/* Continuous states (default storage) */
extern X_qube_servo2_quick_start_T qube_servo2_quick_start_X;

/* Block states (default storage) */
extern DW_qube_servo2_quick_start_T qube_servo2_quick_start_DW;

/* Model entry point functions */
extern void qube_servo2_quick_start_initialize(void);
extern void qube_servo2_quick_start_output(void);
extern void qube_servo2_quick_start_update(void);
extern void qube_servo2_quick_start_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern qube_servo2_quick_start_rtModel *qube_servo2_quick_start(void);
...
extern RT_MODEL_qube_servo2_quick_st_T *const qube_servo2_quick_start_M;
 ...
 *
 * '<Root>' : 'qube_servo2_quick_start'
 * '<S1>'   : 'qube_servo2_quick_start/Degrees to Radians'
 * '<S2>'   : 'qube_servo2_quick_start/Derivative Gain'
 * '<S3>'   : 'qube_servo2_quick_start/Proportional Gain'
 * '<S4>'   : 'qube_servo2_quick_start/Radians to Degrees'
 * '<S5>'   : 'qube_servo2_quick_start/Stall Detection'
 * '<S6>'   : 'qube_servo2_quick_start/Stall Detection/Stall Monitor'
 * '<S7>'   : 'qube_servo2_quick_start/Stall Detection/Stop with Message'
 * '<S8>'   : 'qube_servo2_quick_start/Stall Detection/Stop with Message/Compare'
 */
#endif                               /* RTW_HEADER_qube_servo2_quick_start_h_ */
